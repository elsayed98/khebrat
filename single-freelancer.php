...
if(in_array('khebrat-framework/index.php', apply_filters('active_plugins', get_option('active_plugins'))))
{
	...
	{ 
		...
		{ the_post();
			...
			if($khebrat_theme_options['freelancer_details_page_layout'] == "1")
			{
			...
			if($khebrat_theme_options['freelancer_services'] == "1")
			{
			  ...
			  <div class="container">
				<div class="row">
				  <div class="col-xl-8 col-lg-8 col-md-12 col-sm-12">
					<?php
						$layout = $khebrat_theme_options['detail_page_lower_layout']['enabled'];
						if ( $layout )
						{
				  ...
				  <div class="col-xl-4 col-lg-4 col-md-12 col-sm-12">
					<div class="freelance-sidebar">
						<?php
						$layout_sidebar = $khebrat_theme_options['detail_page_sidebar']['enabled'];
					...
					?>
					 ...
					 <p class="report-button text-center"> <a href="javascript:void(0)" data-bs-toggle="modal" data-bs-target="#report-modal"><i class="fas fa-exclamation-triangle"></i><?php echo esc_html__('Report Freelancer','khebrat_theme'); ?></a></p>
				  </div>
				</div>
			  </div>
			</section>
	<?php
			...
			if($khebrat_theme_options['freelancer_services'] == "2")
			{
				get_template_part( 'template-parts/detail-page/freelancer/services', '');
			}
		}
