...
if(is_page_template( 'page-profile.php' ) || is_page_template( 'dashboard.php' )) 
{

}
	if(is_page_template( 'page-profile.php' ) || is_page_template( 'dashboard.php' ) || is_front_page() || is_page_template( 'page-register.php' ) || is_page_template( 'page-register-lawyer.php' ) || is_page_template( 'page-home.php' ) || is_page_template( 'page-login.php' ) ||  is_singular( array( 'employer', 'freelancer', 'services', 'projects' ) ))
	{
                        ...
                        <div class="col-xl-12 col-lg-12 col-sm-12 col-md-12 col-xs-12">
                            <div class="fr-list-content">
                                ...
                                <div class="fr-list-details">
                                    <ul>
                                        <li><a href="<?php echo home_url( '/' ); ?>"><?php echo esc_html__('Home', 'khebrat_theme' ); ?></a></li>
