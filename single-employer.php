...
if(in_array('khebrat-framework/index.php', apply_filters('active_plugins', get_option('active_plugins'))))
{
	...
	if(empty($banner_img ))
	{
		$cover_img = "style='background-image:url(".$khebrat_theme_options['employer_df_cover']['url'].")'";
	}
	else
	{
			  ...
			  <div class="col-xl-4 col-lg-5 col-md-5 col-sm-5 align-self-center">
				<div class="fr-expert-content">
					<?php if( get_user_meta( get_current_user_id(), '_emp_follow_id_'.$emp_id, true ) == $emp_id ) { ?>
							<a href="javascript:void(0)" class="btn btn-theme following"><?php echo esc_html__('Following','khebrat_theme'); ?></a>
							<?php
						}
						else
						{
							?>
							<a href="javascript:void(0)" class="btn btn-theme-secondary follow-employer" data-emp-id="<?php echo esc_attr($emp_id); ?>"><?php echo esc_html__('Click to Follow','khebrat_theme'); ?></a>
							<?php
		...
		<div class="row">
		  <div class="col-lg-4 col-xl-4 col-md-12 col-xs-12 col-sm-12">
			<div class="fr-c-details">
				...
				<ul>
				  <li>
					<div class="fr-c-more-details">
					  ...
					  <p> <?php echo esc_html__('Projects','khebrat_theme'); ?></p>
					</div>
				  </li>
				  <li class="fr-style-3">
					<div class="fr-c-more-details"> <span><?php echo get_employer_followers($emp_id); ?></span>
					  <p><?php echo esc_html__('Followers','khebrat_theme'); ?></p>
					</div>
				  </li>
				</ul>
			  </div>
			  <div class="fr-ca-more-details">
				<ul>
				<?php
					if($khebrat_theme_options['contact_detail_show'] && $khebrat_theme_options['contact_detail_show'] == 1)
					{
						?>
						<li>
						<div class="fr-c-full-details"> <span><?php echo esc_html__('Contact Number','khebrat_theme'); ?></span>
						  <p><?php echo esc_html(get_post_meta( $emp_id, '_employer_contact_number' , true )); ?></p>
						</div>
						</li>
						<li>
						<div class="fr-c-full-details"> <span><?php echo esc_html__('Email Address','khebrat_theme'); ?></span>
						  <p><?php echo esc_html($user_info->user_email); ?></p>
						</div>
						</li>
						<?php
					}
					else if($khebrat_theme_options['contact_detail_show'] && $khebrat_theme_options['contact_detail_show'] == 3)
					{
						if(!is_user_logged_in())
						{
							...
							<li>
							<div class="fr-c-full-details"> <span><?php echo esc_html__('Contact Number','khebrat_theme'); ?></span>
							  <p><?php echo esc_html__('Login to view....','khebrat_theme'); ?></p>
							</div>
							</li>
							<li>
							<div class="fr-c-full-details"> <span><?php echo esc_html__('Email Address','khebrat_theme'); ?></span>
				...
				?>
                <?php
                if(isset($khebrat_theme_options['employer_department']) && $khebrat_theme_options['employer_department'] == 3){
                }
                else {
                    ?>
				  <li>
					<div class="fr-c-full-details"> <span><?php echo esc_html__('Department','khebrat_theme'); ?></span>
					  <p>
						<?php
							...
							{
								echo esc_html__('N/A','khebrat_theme');
							}
						?>
					  </p>
					</div>
                ...
                <?php } ?>
                    <?php
                    if(isset($khebrat_theme_options['employer_employee_count']) && $khebrat_theme_options['employer_employee_count'] == 3){
                    }
                    else {
                        ?>
				        <li>
                            <div class="fr-c-full-details"> <span><?php echo esc_html__('Number of Employees','khebrat_theme'); ?></span>
                              <p>
                                <?php
                    ...
                    <?php } ?>
				  <li>
					<div class="fr-c-full-details"> <span><?php echo esc_html__('Member Since','khebrat_theme'); ?></span>
                ...
                <li>
                    <div class="fr-c-full-details"> <span><?php echo esc_html__('Total Views','khebrat_theme'); ?></span>
                        <p><i class="far fa-eye" style="margin-right: 5px;"></i><?php echo wp_sprintf(esc_html__('%s Views', 'khebrat_theme'), number_format(get_post_meta($emp_id, 'exertio_employer_total_views', true)));?></p>
                    </div>
                </li>
                <?php } ?>
				</ul>
			 ...
			 <p class="report-button text-center"> <a href="javascript:void(0)" data-bs-toggle="modal" data-bs-target="#report-modal"><i class="fas fa-exclamation-triangle"></i><?php echo esc_html__('Report Employer','khebrat_theme'); ?></a></p>
			<div class="fr-lance-banner">
			 <?php
				if(isset($khebrat_theme_options['employer_ad_1']))
				{
					echo wp_return_echo($khebrat_theme_options['employer_ad_1']);
				}
			 ?>
			 </div>
		  </div>
		  <div class="col-lg-8 col-xl-8 col-md-12 col-xs-12 col-sm-12">
			<div class="fr-product-des-box heading-contents custom-class">
			  <h3><?php echo esc_html__('About Us','khebrat_theme'); ?></h3>
							...
							<div class="fr-right-detail-box">
									 ...
									 <div class="style-hd">
									  ...
									  <?php
										...
										if($project_type == 'hourly' || $project_type == 2)
										{
											...
											echo '<p class="price_type protip" data-pt-title="'.esc_attr__('For ','khebrat_theme').$hours.__(' hours total will be  ','khebrat_theme'). fl_price_separator(intval($hours)*intval($price)).'" data-pt-position="top" data-pt-scheme="black">'.$project_type_text.' <i class="far fa-question-circle"></i></p>';
										}
							  ...
							  <div class="fr-right-information">
								<div class="fr-right-list">
								  <ul>
									<li>
									  <p class="heading"><?php echo esc_html__('Duration: ','khebrat_theme'); ?></p>
									  <span>
										<?php
									...
									<li>
									  <p class="heading"><?php echo esc_html__('Level: ','khebrat_theme'); ?></p>
									  <span>
										<?php
									...
									<li>
									  <p class="heading"><?php echo esc_html__('Location: ','khebrat_theme'); ?></p>
									  <span>
											<?php
								...
								<div class="fr-right-bid">
								  <ul>
									...
									<li><a href="<?php echo esc_url(get_permalink()); ?>" class="btn btn-theme"><?php echo esc_html__('View Detail','khebrat_theme'); ?></a></li>
								  </ul>
								</div>
							  </div>
							</div>
