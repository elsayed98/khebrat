			...
			<div class="col-xl-12 col-xs-12 col-sm-12 col-md-12">
				<div class="fr-er-404">
					<div class="fr-er-content">
						...
						<h2><span><?php echo esc_html__( 'Oops!', 'khebrat_theme' ).'</span> '.esc_html__( 'Page Not Found', 'khebrat_theme' ); ?></h2>
						<p><?php echo esc_html__( "We're sorry, but the page you were looking for doesn't exist or temporarily unavailable.", 'khebrat_theme' ); ?></p>
					</div>
					<div class="fr-er-list">
						<span><a href="<?php echo esc_url( home_url( '/' ) ); ?>" class="btn btn-theme"><?php echo esc_html__('Go to Home', 'khebrat_theme' ); ?><i class="fa fa-long-arrow-right"></i></a></span>
					</div>
				</div>
			</div>
		</div>
