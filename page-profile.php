            ...
            <div class="container-fluid page-body-wrapper">
              ...
              <div class="main-panel">
				...
				if(fl_framework_get_options('fl_allow_user_email_verification') != null && fl_framework_get_options('fl_allow_user_email_verification') == true)
				{
					...
					{
						$resent_msg = '<a href="javascript:void(0)" class="register_email_again"> '.esc_html__('Resend Email?','khebrat_theme').'</a>';
					}
					else
					{
						$resent_msg = esc_html__('Resend again in ','khebrat_theme'). $minutes.esc_html__(' minutes ','khebrat_theme'). $seconds.esc_html__(' seconds','khebrat_theme');
					}
...

					{
						...
						<div class="exertio-alert alert alert-danger alert-dismissible fade show" role="alert">
							<div class="exertio-alart-box">
								...
								<div class="text-info">
									<h5><?php echo esc_html__('Your email address is not verified','khebrat_theme'); ?> </h5>
									<p>
