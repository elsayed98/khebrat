				...
				<div class="col-lg-6 col-xs-12 col-sm-12 col-xl-6 col-md-12 align-self-center no-padding-hero">
					<div class="fr-sign-container">
						<div class="fr-sign-content">
									...
									<div class="exertio-alart-box">
										<div class="text-info">
											<p>
												...
												<button class="fr_send_email" type="button"><?php echo esc_html__('Resend Email', 'khebrat_theme'); ?></button>
											</p>
										</div>
									</div>
								</div>
							<?php } ?>
							<?php
							if (isset($khebrat_theme_options['register_logo_show']) && $khebrat_theme_options['register_logo_show'] == 1) {
							?>
								<div class="auth-logo"><a href="<?php echo get_home_url(); ?>"><img src="<?php echo esc_url($khebrat_theme_options['dasboard_logo']['url']); ?>" alt="<?php echo esc_attr(get_post_meta($khebrat_theme_options['dasboard_logo']['id'], '_wp_attachment_image_alt', TRUE)); ?>" class="img-fluid" /></a></div>
							<?php
							}
							?>
							<div class="heading-panel">
								<h2><?php echo esc_html($khebrat_theme_options['register_heading_text']); ?></h2>
								<p><?php echo esc_html($khebrat_theme_options['register_textarea']); ?></p>
							</div>
							<form id="signup-form">
								<div class="fr-sign-form">
									<?php
									$user_count = '';
									if (isset($khebrat_theme_options['user_registration_type']) && $khebrat_theme_options['user_registration_type'] == 'both_selected') {
										if (!empty($khebrat_theme_options['user_registration_type_selection'])) {
											$user_count = count($khebrat_theme_options['user_registration_type_selection']);
										}
									}

									if (isset($khebrat_theme_options['user_registration_type']) && $khebrat_theme_options['user_registration_type'] == 'both_selected' && $user_count == 2) {
									?>
										<div class="form-group register-type">
											<div class="register-type-btn">
												<label class="radio">
													<input class="" type="radio" value="employer" name="exertio_user_type" checked="checked"><span><?php echo esc_html__('Employer', 'khebrat_theme'); ?></span>
												</label>
											</div>
											<div class="register-type-btn">
												<label class="radio">
													<input class="" type="radio" value="freelancer" name="exertio_user_type"><span><?php echo esc_html__('Freelancer', 'khebrat_theme'); ?></span>
												</label>
											</div>
										</div>
									<?php
									...
									<div class="fr-sign-form">
										...
										<div class="form-group">
											<input type="text" name="fl_full_name" placeholder="<?php echo esc_attr__('Display name', 'khebrat_theme'); ?>" class="form-control" required data-smk-msg="<?php echo esc_attr__('Display name required', 'khebrat_theme'); ?>">
										</div>
									</div>
									<div class="fr-sign-form">
										...
										<div class="form-group">
											<input type="text" name="fl_username" placeholder="<?php echo esc_attr__('Username', 'khebrat_theme'); ?>" class="form-control" required data-smk-msg="<?php echo esc_attr__('Please provide username', 'khebrat_theme'); ?>">
										</div>
									</div>
									<div class="fr-sign-form">
										...
										<div class="form-group">
											<input type="email" name="fl_email" placeholder="<?php echo esc_attr__('Email address', 'khebrat_theme'); ?>" class="form-control" required data-smk-msg="<?php echo esc_attr__('Email address is required', 'khebrat_theme'); ?>">
										</div>
									</div>
									<div class="fr-sign-form">
										...
										<div class="form-group">
											<input type="password" name="fl_password" placeholder="<?php echo esc_attr__('Password', 'khebrat_theme'); ?>" class="form-control" id="password-field" required data-smk-msg="<?php echo esc_attr__('Please provide password', 'khebrat_theme'); ?>">
											<div data-toggle="#password-field" class="fa fa-fw fa-eye field-icon toggle-password"></div>
										</div>
									</div>
									<?php
									$recaptcha = "";
									$site_key = $khebrat_theme_options['google_recaptcha_key'];
									$contact_recaptcha = isset($khebrat_theme_options['signin_form_recaptcha_switch']) ? $khebrat_theme_options['signin_form_recaptcha_switch'] : false;
									if (isset($khebrat_theme_options['google_recaptcha_key']) && $khebrat_theme_options['google_recaptcha_key'] != "" && $contact_recaptcha) { ?>
										<div class="fr-sign-form">
									...
									<div class="fr-sigin-requirements">
										<div class="form-group">
											...
											<span class="sr-style"><?php echo esc_html__('I agree to the', 'khebrat_theme'); ?> <a href="<?php echo get_the_permalink($khebrat_theme_options['terms_condition_page']); ?>"><?php echo esc_html__('Terms and Conditions', 'khebrat_theme'); ?></a> </span>
										</div>
									</div>
									<?php
									$redirect_page = isset($_GET['redirect']) ? $_GET['redirect'] : '';
									if (isset($redirect_page) && $redirect_page != '') {
										$login_page = get_the_permalink($khebrat_theme_options['login_page']) . '?redirect=' . $redirect_page;
									} else {
										$login_page = get_the_permalink($khebrat_theme_options['login_page']);
									}
									?>
									<div class="fr-sign-submit">
										<div class="form-group d-grid">
											<button type="button" class="btn btn-theme btn-loading" id="signup-btn" data-redirect-id="<?php echo esc_attr($redirect_page); ?>"> <?php echo esc_html__('Create Account', 'khebrat_theme'); ?>
							...
							<div class="fr-sign-bundle-content">
								<p> <?php echo esc_html__('Already have an account?', 'khebrat_theme'); ?> <span><a href="<?php echo esc_url($login_page); ?>"><?php echo esc_html__('Login here', 'khebrat_theme'); ?></a></span></p>
							</div>
						</div>
					</div>
				</div>
				<div class="col-xl-6 col-lg-6 col-md-12 col-sm-12">
					<div class="fr-sign-user-dashboard d-flex align-items-end">
						<div class="sign-in owl-carousel owl-theme">
							<?php
							$slides = $khebrat_theme_options['register_slides'];
