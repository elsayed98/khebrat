...
class fl_db_tables 
{
    public static function fl_create_db_tables() 
	{
	   ...
	   $sql_project_offers = "
        CREATE TABLE ".EXERTIO_PROJECT_OFFER_TBL." (
        `id` int (11) NOT NULL AUTO_INCREMENT,
        `timestamp` datetime ,
		`updated_on` datetime,
		`project_id` int (11),
		...
		`earned_cost` float(9,2),
		`day_to_complete` int (11),
		`allowed_hours` int (11),
		`cover_letter` text (300),
		`offer_Status` text (30),
		`freelancer_id` int (11),
		`author_id` int (11),
         PRIMARY KEY (id)
        ) ENGINE=InnoDB DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 ;";
        maybe_create_table( EXERTIO_PROJECT_OFFER_TBL, $sql_project_offers );
   ...
   $sql_statements = "
                        ...
                        maybe_create_table($table_name, $sql_statements );
