    ...
    public function widget( $args, $instance )
    {
        ...
        <div class="panel panel-default">
            ...
            <div id="freelancer-gender-widget" class="panel-collapse collapse <?php echo esc_attr($show); ?>" role="tabpanel" >
                <div class="panel-body ">
                    <select class="category form-control submit_on_select" name="gender" data-placeholder="<?php echo __('Select Option', 'khebrat_theme') ?>">
<!--                        <option label=""></option>-->
                        <?php
                        $conditions = array('0' => __('Male', 'khebrat_theme'),'1' => __('Female', 'khebrat_theme'), '2' => __('Other', 'khebrat_theme'));
