				...
				<div class="fr-hero-hire">
					...
					<div class="fr-hero-short-list-2">
						<div class="fr-hero-hire-content">
							...
							?>
								<a href="<?php echo esc_url($fl_portfolio); ?>" class="btn fl_portfolio"><?php echo esc_html__('Portfolio', 'khebrat_theme'); ?></a>
							<?php
							}
							?>
						</div>
				...
				<div class="col-lg-12 col-xl-12 col-xs-12 col-md-12 col-sm-12">
					<div class="fr-hero-m-jobs-bottom">
						<ul>
							...
							?>
							<li> <span><small><?php echo exertio_get_posts_count('', 'projects', '', 'ongoing', $meta_query); ?></small> <?php echo esc_html__('Ongoing Projects', 'khebrat_theme'); ?></span> </li>
							<li> <span><small><?php echo exertio_get_posts_count('', 'projects', '', 'completed', $meta_query); ?></small> <?php echo esc_html__('Completed Projects', 'khebrat_theme'); ?></span> </li>
							<li> <span><small><?php echo exertio_get_services_count($fl_id, 'ongoing'); ?></small> <?php echo esc_html__('Services in Queue', 'khebrat_theme'); ?></span> </li>
							<li> <span><small><?php echo exertio_get_services_count($fl_id, 'completed'); ?></small> <?php echo esc_html__('Completed Services', 'khebrat_theme'); ?></span> </li>
						</ul>
					</div>
				</div>
			</div>
