...
?>
	<div class="main-box">
		<?php
		if(isset($khebrat_theme_options['detail_edu_title']) && $khebrat_theme_options['detail_edu_title'] != '')
		{
			?>
			<div class="heading-contents">
			  <h3><?php echo esc_html($khebrat_theme_options['detail_edu_title']); ?></h3>
			</div>
			<?php
		}
		?>
								...
								<div class="fr-expertise-details">
								  ...
								  <ul class="experties-meta">
									...
									?>
										<li>
											<span>
												<?php echo date_i18n( get_option( 'date_format' ), strtotime( $edu_json['edu_start_date'] ) ); ?> - <?php if($edu_json['edu_end_date'] == '') { echo esc_html__('continue','khebrat_theme');} else { echo date_i18n( get_option( 'date_format' ), strtotime( $edu_json['edu_end_date'] ) ); } ?>
											</span>
										</li>
									<?php
									}
