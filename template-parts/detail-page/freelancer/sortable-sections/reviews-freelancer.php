...
?>
	<div class="main-box">
	  <div class="fr-recent-review-box">
		<?php
		if(isset($khebrat_theme_options['detail_freelancer_reviews_title']) && $khebrat_theme_options['detail_freelancer_reviews_title'] != '')
		{
			?>
			<div class="heading-contents">
			  <h3><?php echo esc_html($khebrat_theme_options['detail_freelancer_reviews_title']); ?></h3>
			</div>
			<?php
		}
		?>
					...
					<div class="fr-recent-content">
						<div class="reviews-header">
							...
							<div class="fr-recent-rating">
								...
								<span class="xm"><?php echo esc_html__('out of 5','khebrat_theme');?></span>
							</div>
