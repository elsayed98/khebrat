...
?>
	<div class="main-box">
		<?php
		if(isset($khebrat_theme_options['detail_projects_title']) && $khebrat_theme_options['detail_projects_title'] != '')
		{
			?>
			<div class="heading-contents">
			  <h3><?php echo esc_html($khebrat_theme_options['detail_projects_title']); ?></h3>
			</div>
			<?php
		}
		?>
