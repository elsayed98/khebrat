...
if(isset($khebrat_theme_options['freelancer_services_limit']))
{
	$limit = $khebrat_theme_options['freelancer_services_limit'];
}
        ...
        <div class="row">
          <div class="col-xl-12 col-sm-12 col-md-12 col-xs-12 col-lg-12">
          	<div class="fr-top-services fr-bg-white-2">
            	<?php
                        if(isset($khebrat_theme_options['freelancer_services_title']))
                        {
                            ?>
                            <div class="heading-contents">
                              <h3><?php echo esc_html($khebrat_theme_options['freelancer_services_title']); ?></h3>
                            </div>
                            <?php
                        }
                    ?>
								  ...
								  <div class="item">
									<div class="fr-top-contents">
									  <div class="fr-top-product">
										...
										{
											echo '<div class="fr-top-featured"> <span class="badge">'.esc_html__( 'Featured', 'khebrat_theme' ).'</span> </div>';
										}
									  ...
									  <div class="fr-top-details">
										...
										<p><?php echo esc_html__('Starting From','khebrat_theme'); ?><span class="style-6"><?php echo fl_price_separator(get_post_meta($sid, '_service_price', true), 'html'); ?></span></p>
