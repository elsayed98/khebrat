...
?>
	<div class="fr-product-progress sidebar-box">
		<?php
		if(isset($khebrat_theme_options['detail_sidebar_skills']) && $khebrat_theme_options['detail_sidebar_skills'] != '')
		{
			?>
			<div class="sidebar-heading">
				<h3><?php echo esc_html($khebrat_theme_options['detail_sidebar_skills']); ?></h3>
			</div>
			<?php
		}
		?>
