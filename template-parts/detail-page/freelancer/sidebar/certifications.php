...
?>
	<div class="fr-recent-certification sidebar-box">
		<?php
		if(isset($khebrat_theme_options['detail_sidebar_certificates']) && $khebrat_theme_options['detail_sidebar_certificates'] != '')
		{
			?>
			<div class="sidebar-heading">
				<h3><?php echo esc_html($khebrat_theme_options['detail_sidebar_certificates']); ?></h3>
			</div>
			<?php
		}
		?>
