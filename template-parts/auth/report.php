...
{
	$report_title = esc_html__('Report this Freelancer', 'khebrat_theme');
}
else if (  is_singular( 'services' ))
{
	$report_title = esc_html__('Report this Service', 'khebrat_theme');
}
else if ( is_singular( 'projects' ) )
{
	$report_title = esc_html__('Report this Project', 'khebrat_theme');
}
if (is_singular( 'employer' ) )
{
	$report_title = esc_html__('Report this Employer', 'khebrat_theme');
}
?>
        ...
        <div class="modal-body">
			<div class="fr-report-form">
				<div class="form-group">
					<label><?php echo esc_html__('Choose Reason','khebrat_theme'); ?></label>
					<?php
				...
				<div class="form-group">
				  <label><?php echo esc_html__('Provide details','khebrat_theme'); ?></label>
				  <textarea name="report_desc" class="form-control" id="" class="form-control" required data-smk-msg="<?php echo esc_attr__('Required field','khebrat_theme');?>"></textarea>
				</div>
				<div class="form-group">
					<input type="hidden" id="fl_report_nonce" value="<?php echo wp_create_nonce('fl_report_secure'); ?>"  />
					<button type="button" id="btn-report" class="btn btn-theme btn-loading btn-report" data-post-id="<?php echo esc_attr($pid); ?> "><?php echo esc_html__("Save & Submit", 'khebrat_theme'); ?><span class="bubbles"> <i class="fa fa-circle"></i> <i class="fa fa-circle"></i> <i class="fa fa-circle"></i> </span></button>
				</div>
			</div>
