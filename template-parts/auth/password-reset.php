    ...
    <div class="modal-content">
      <form class="modal-from new-my-pass" method="POST" id="mynewPass">
        <div class="modal-header">
          <h5 class="modal-title"><?php echo esc_html__('Reset Your Password', 'khebrat_theme'); ?></h5>
        ...
        <div class="fr-sign-form">
          ...
          <div class="form-group">
            <input type="password" required data-smk-msg="<?php echo esc_attr__('New password is needed','khebrat_theme'); ?>" name="password" class="form-control" placeholder="<?php echo esc_attr__('Enter new password','khebrat_theme'); ?>">
            </div>
            <div class="form-group">
                ...
                <button type="button" class="btn btn-theme btn-loading btn-reset-new"><?php echo esc_html__("Change My Password", 'khebrat_theme'); ?><span class="bubbles"> <i class="fa fa-circle"></i> <i class="fa fa-circle"></i> <i class="fa fa-circle"></i> </span></button>
            </div>
        </div>
