					  ...
					  <div class="fr-latest-style-detai">
						<ul>
						  ...
						  <?php
							...
							if($comments >1)
							{
								$comment_text = esc_html(get_comments_number()).esc_html__(' Comments', 'khebrat_theme');
							}
							else if ($comments == 0)
							{
								$comment_text = esc_html__(' No Comments', 'khebrat_theme');
							}
							else
							{
								$comment_text = esc_html(get_comments_number()).esc_html__(' Comment', 'khebrat_theme');
							}
						  ?>
					...
					<div class="fr-latest-tags-2">
					  <div class="fr-latest-t-content">
						<div class="fr-latest-t-box">
							<?php 
								$before = "<span>".esc_html__(' Tags', 'khebrat_theme')."</span>";
								$seperator = '';
								$after = '';
