...
<div class="container mt-5">
    <div class="card shadow">
        <div class="card-body content-wrapper">
            <h3 class="text-center mb-4"><?php echo get_the_title($khebrat_theme_options['page_legal_writing']); ?> - لائحة نقض</h3>
            <form id="legal_services_form">
                ...
                <div class="step">
                    ...
                    <div class="row">
                        ...
                        $objection_start_date_type = get_post_meta($lsid, '_objection_start_date_type', true);
                        ...
                        <!-- التاريخ -->
                        <div class="mb-4">
                            <label class="form-label fw-bold">تاريخ بداية الاعتراض على الحكم حسب تاريخ صدور صك الحكم أو استلام الصك؟</label>
                        ...
                        <div class="mb-4">
                            <label class="form-label fw-bold">مدة الاعتراض على الحكم حسب صك الحكم</label>

                            <label class="btn btn-outline-primary w-100 p-3 d-flex align-items-center mb-2 <?php if ($objection_period_type == 'normal') echo 'active'; ?>">
                                <input type="radio" name="objection_period_type" class="d-none" value="normal"
                                    <?php if ($objection_period_type == 'normal') echo 'checked'; ?>>
                                <div>
                                    <h6 class="mb-0">30 يوم (للأحكام العادية)</h6>
                                </div>
                            </label>

                            <label class="btn btn-outline-primary w-100 p-3 d-flex align-items-center <?php if ($objection_period_type == 'urgent') echo 'active'; ?>">
                                <input type="radio" name="objection_period_type" class="d-none" value="urgent"
                                    <?php if ($objection_period_type == 'urgent') echo 'checked'; ?>>
                                <div>
                                    <h6 class="mb-0">10 يوم (للأحكام الصادرة في المسائل المستعجلة)</h6>
                                </div>
                            </label>
                        </div>
                ...
                <div class="step">
                    ...
                    <div class="mb-4">
                        <h4 class="mb-2">هل ينطبق أحد أسباب النقض التالية أو جميعها؟</h4>
                        <p class="text-muted mb-3">يرجى اختيار واحد من الخيارات التالية</p>

                        <div class="annulment-reasons-radio">
                            <!-- الخيار 1 -->
                            <label class="btn btn-outline-primary w-100 p-3 d-flex align-items-center mb-2 <?php if ($annulment_reasons == 'sharia_violation') echo 'active'; ?>">
                                <input type="radio" name="annulment_reasons" class="d-none" value="sharia_violation"
                                    <?php if ($annulment_reasons == 'sharia_violation') echo 'checked'; ?>>
                                <div>
                                    <h6 class="mb-0">مخالفة أحكام الشريعة الإسلامية وما يصدره ولي الأمر من أنظمة لا تتعارض معها</h6>
                                </div>
                            </label>

                            <!-- الخيار 2 -->
                            <label class="btn btn-outline-primary w-100 p-3 d-flex align-items-center mb-2 <?php if ($annulment_reasons == 'invalid_court_formation') echo 'active'; ?>">
                                <input type="radio" name="annulment_reasons" class="d-none" value="invalid_court_formation"
                                    <?php if ($annulment_reasons == 'invalid_court_formation') echo 'checked'; ?>>
                                <div>
                                    <h6 class="mb-0">صدور الحكم من محكمة غير مشكلة تشكيلاً سليماً طبقاً لما نص عليه نظاماً</h6>
                                </div>
                            </label>

                            <!-- الخيار 3 -->
                            <label class="btn btn-outline-primary w-100 p-3 d-flex align-items-center mb-2 <?php if ($annulment_reasons == 'non_competent_court') echo 'active'; ?>">
                                <input type="radio" name="annulment_reasons" class="d-none" value="non_competent_court"
                                    <?php if ($annulment_reasons == 'non_competent_court') echo 'checked'; ?>>
                                <div>
                                    <h6 class="mb-0">صدور الحكم من محكمة أو دائرة غير مختصة</h6>
                                </div>
                            </label>

                            <!-- الخيار 4 -->
                            <label class="btn btn-outline-primary w-100 p-3 d-flex align-items-center mb-2 <?php if ($annulment_reasons == 'fact_mischaracterization') echo 'active'; ?>">
                                <input type="radio" name="annulment_reasons" class="d-none" value="fact_mischaracterization"
                                    <?php if ($annulment_reasons == 'fact_mischaracterization') echo 'checked'; ?>>
                                <div>
                                    <h6 class="mb-0">الخطأ في تكييف الواقعة، أو وصفها وصفاً غير سليم</h6>
                                </div>
                            </label>

                            <!-- الخيار 5 -->
                            <label class="btn btn-outline-primary w-100 p-3 d-flex align-items-center <?php if ($annulment_reasons == 'dont_know') echo 'active'; ?>">
                                <input type="radio" name="annulment_reasons" class="d-none" value="dont_know"
                                    <?php if ($annulment_reasons == 'dont_know') echo 'checked'; ?>>
                                <div>
                                    <h6 class="mb-0">لا أعلم</h6>
                                </div>
                            </label>
                        </div>
                    </div>
                ...
                <div class="step">
                    ...
                    <?php
                    $objection_reason = get_post_meta($lsid, '_objection_reason', true);
                    $legal_references = get_post_meta($lsid, '_legal_references', true);
                    ?>
                    <!-- سبب النقض  -->
                    <div class="mb-4">
                        <label class="form-label fw-bold">سبب النقض </label>
                        <textarea name="objection_reason" rows="5" class="form-control"
                            placeholder="يرجى شرح الأسباب من وجهة نظرك بشكل واضح ومختصر ويفضل على شكل نقاط حتى يتمكن المحامي أو المحامية من فهم موقفك القانوني"><?php echo esc_textarea($objection_reason); ?></textarea>
                    </div>
