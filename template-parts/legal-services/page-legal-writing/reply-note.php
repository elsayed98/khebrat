<?php
//صفحة - كتابات قانونية - مذكرة رد على الدعوى
            ...
            <form id="legal_services_form">
                ...
                <div class="step">
                    ...
                    <div class="row">
                        ...
                        <!-- حقول المدعى عليه -->
                        <div class="form-group" id="defendantFields">
                        ...
                        <div class="form-group" id="defendantPlaintiffRole">
                ...
                <div class="step">
                    ...
                    <?php
                    $reply_to_claim = get_post_meta($lsid, '_reply_to_claim', true);
                    $legal_references = get_post_meta($lsid, '_legal_references', true);
                    ?>
                    <!-- الرد على الدعوى -->
                    <div class="mb-3">
                        <label class="form-label fw-bold">الرد على الدعوى</label>
                        <textarea name="reply_to_claim" rows="4" class="form-control" required placeholder="يرجى شرح الرد المراد تقديمه من وجهة نظرك بشكل واضح ومختصر ويفضل على شكل نقاط حتى يتمكن المحامي أو المحامية من فهم موقفك القانوني"><?php echo esc_textarea($reply_to_claim); ?></textarea>
                    </div>
