<?php
//صفحة - كتابات قانونية - مذكرة رد جوابية
...
<div class="container mt-5">
    <div class="card shadow">
        <div class="card-body content-wrapper">
            <h3 class="text-center mb-4"><?php echo get_the_title($khebrat_theme_options['page_legal_writing']); ?> - مذكرة رد جوابية</h3>
            <form id="legal_services_form">
                ...
                <div class="step">
                    ...
                    <?php
                    $legal_answer = get_post_meta($lsid, '_legal_answer', true);
                    $legal_references = get_post_meta($lsid, '_legal_references', true);
                    ?>
                    <!--الجواب-->
                    <div class="mb-3">
                        <label class="form-label fw-bold">الجواب</label>
                        <textarea name="legal_answer" rows="4" class="form-control" required placeholder="يرجى شرح الجواب المراد تقديمه من وجهة نظرك بشكل واضح ومختصر ويفضل على شكل نقاط حتى يتمكن المحامي أو المحامية من فهم موقفك القانوني"><?php echo esc_textarea($legal_answer); ?></textarea>
                    </div>
                ...
                <div class="step">
                    ...
                    <div class="d-flex justify-content-between mt-4">
                        ...
                        <input type="hidden" name="service_type_writing" value="response_memo" />
