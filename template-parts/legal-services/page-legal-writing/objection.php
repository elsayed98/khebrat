<?php
//صفحة - كتابات قانونية - لائحة اعتراض
...
<div class="container mt-5">
    <div class="card shadow">
        <div class="card-body content-wrapper">
            <h3 class="text-center mb-4"><?php echo get_the_title($khebrat_theme_options['page_legal_writing']); ?> - لائحة اعتراض</h3>
            <form id="legal_services_form">
                ...
                <div class="step">
                    ...
                    ?>
                    <!-- سبب الاعتراض على الحكم -->
                    <div class="mb-4">
                        <label class="form-label fw-bold">سبب الاعتراض على الحكم</label>
                ...
                <div class="step">
                    ...
                    <div class="d-flex justify-content-between mt-4">
                        ...
                        <input type="hidden" name="service_type_writing" value="objection" />
