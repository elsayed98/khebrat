...
<div class="container mt-5">
    <div class="card shadow">
        <div class="card-body content-wrapper">
            <h3 class="text-center mb-4"><?php echo get_the_title($khebrat_theme_options['page_legal_writing']); ?> - لائحة التماس</h3>
            <form id="legal_services_form">
                ...
                <div class="step">
                    ...
                    <div class="row">
                        ...
                        <!-- التاريخ -->
                        <div class="mb-4">
                            <label class="form-label fw-bold">تاريخ صدور الحكم الذي ترغب بتقديم طلب الالتماس عليه؟</label>
                ...
                <div class="step">
                    ...
                    <!-- سبب النقض  -->
                    <div class="mb-4">
                        <label class="form-label fw-bold">سبب الالتماس </label>
                ...
                <div class="step">
                    ...
                    <div class="d-flex justify-content-between mt-4">
                        ...
                        <input type="hidden" name="service_type_writing" value="petition" />
