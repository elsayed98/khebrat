            ...
            <div class="col-lg-4 col-xs-12 col-sm-12 col-md-12 col-xl-4">
                <div class="project-sidebar">
                    <div class="heading">
                        ...
                        ?>
                        <a href="<?php echo esc_url(get_the_permalink($employer_page)); ?>"><?php echo esc_html__('Clear Result','khebrat_theme'); ?></a>
                    </div>
                	...
                	<form>
						...
						<div class="filters">
							<select class="default-select" name="sort" id="order_by">
								...
								<option value="desc" <?php if($sort == 'desc'){ echo "selected"; } ?>> <?php echo __( 'Date: Newer First', 'khebrat_theme' ); ?></option>
								<option value="asc" <?php if($sort == 'asc'){ echo "selected"; } ?>> <?php echo __( 'Date: Older First', 'khebrat_theme' ); ?></option>
							</select>
							<?php
							if(isset($_GET) && $_GET != '')
							{
