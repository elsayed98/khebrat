            ...
            <div class="col-lg-4 col-xs-12 col-sm-12 col-md-12 col-xl-4">
                <div class="project-sidebar">
                    <div class="heading">
                        ...
                        ?>
                        <a href="<?php echo esc_url(get_the_permalink($freelancer_page)); ?>"><?php echo esc_html__('Clear Result','khebrat_theme'); ?></a>
                    </div>
                	...
                	<form>
						...
						<div class="filters">
							<ul class="top-filters">
									...
									<li>
										<a href="javascript:void(0)" class="services-grid-icon protip <?php echo esc_attr($grid_active); ?> list-style" data-pt-position="top" data-pt-scheme="black" data-pt-title="<?php echo __( 'Grid View', 'khebrat_theme' ); ?>" data-list-style="grid">
											<span></span>
											<span></span>
											<span></span>
										</a>
							...
							<select class="default-select" name="sort" id="order_by">
								...
								<option value="desc" <?php if($sort == 'desc'){ echo "selected"; } ?>> <?php echo __( 'Date: Descending', 'khebrat_theme' ); ?></option>
								<option value="asc" <?php if($sort == 'asc'){ echo "selected"; } ?>> <?php echo __( 'Name: Ascending', 'khebrat_theme' ); ?></option>
							</select>
							<?php
							if(isset($_GET) && $_GET != '')
							{
