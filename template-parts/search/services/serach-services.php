...
$list_style     =   isset($khebrat_theme_options['service_view_type']) ? $khebrat_theme_options['service_view_type'] : "grid";
...
$is_search_bar   =  isset($khebrat_theme_options['sevices_search_bar'])  ?  $khebrat_theme_options['sevices_search_bar']  : true;   
            ...
            <ul>
              <li>
                <div class="form-group">
                  <input type="text" placeholder="<?php echo esc_attr__( 'What are you looking for?', 'khebrat_theme' ); ?>" class="form-control" name="title" value="<?php echo esc_attr($title_value); ?>">
                </div>
              </li>
                <li>
                    <select class="multi_select" name="category">
                        <option value=""> <?php echo __( 'Select Category', 'khebrat_theme' ); ?> </option>
                        <?php echo get_hierarchical_terms('service-categories','', $cat_value ); ?>
                    </select>
                </li>
              <li> <button type="submit" class="btn btn-style btn-block"><?php echo __( 'Search', 'khebrat_theme' ); ?></button> </li>
            </ul>
            </div>
            <?php
				if(isset($_GET) && $_GET != '')
            ...
            <div class="col-xl-4 col-xs-12 col-sm-12 col-md-12">
                <div class="service-side position-sticky">
                    <div class="heading">
                        ...
                        ?>
                        <a href="<?php echo esc_url(get_the_permalink($services_page)); ?>"><?php echo esc_html__('Clear Result','khebrat_theme'); ?></a>
                    </div>
                        ...
                        <form>
                                ...
                                <div class="filters">
									<ul class="top-filters">
                                            ...
                                            ?>
                                            <li>
                                                <a href="javascript:void(0)" class="services-list-icon protip <?php echo esc_attr($list_active); ?> list-style" data-pt-position="top" data-pt-scheme="black" data-pt-title="<?php echo esc_attr__( 'List View', 'khebrat_theme' ); ?>" data-list-style="list">
                                                    <span></span>
                                                    <span></span>
                                                    <span></span>
                                                </a>
                                            ...
                                            <li>
                                                <a href="javascript:void(0)" class="services-grid-icon protip <?php echo esc_attr($grid_active); ?> list-style" data-pt-position="top" data-pt-scheme="black" data-pt-title="<?php echo esc_attr__( 'Grid View', 'khebrat_theme' ); ?>" data-list-style="grid">
                                                    <span></span>
                                                    <span></span>
                                                    <span></span>
                                                </a>
