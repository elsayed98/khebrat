                                                                            ...
                                                                            <div>
                                                                                <div class="bg-primary text-dark p-2 rounded-3">
                                                                                    <small class="text-light d-block">
                                                                                        ...
                                                                                        <?php echo exertio_get_username('lawyer', $message->msg_sender_id, 'badge', 'right'); ?>
                                                                                    </small>
                                                                        ...
                                                                        <div class="d-flex align-items-start justify-content-end mb-3">
                                                                            <div class="text-end">
                                                                                <div class="bg-light text-span p-2 rounded-3">
                                                                                    <small class="d-block"><?php echo exertio_get_username('customer', $message->msg_sender_id, 'badge', 'left'); ?></small>
                                                                                    <?php echo esc_html(wp_strip_all_tags($message->message)); ?>
                                                                                    <?php
                                                                                    if ($message->attachment_ids > 0) {
                                                                                    ?>
