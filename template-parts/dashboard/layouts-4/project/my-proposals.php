      ...
      <div class="d-flex justify-content-between flex-wrap">
        <div class="d-flex align-items-end flex-wrap">
          <div class="mr-md-3 mr-xl-5">
            <h2><?php echo esc_html__('My Proposals','khebrat_theme'); ?></h2>
				  ...
				  <div class="pro-coulmn">
					  <?php 
							...
							else if($type == 'hourly' || $type == 2)
							{
								...
								echo '<small class="estimated-hours">'.esc_html__( 'Estimated Hours ', 'khebrat_theme' ).$result->day_to_complete.'</small>';
							}
						 ?>
				  </div>
				  <div class="pro-coulmn">
					<span class="pro-btns">
						  <a href="javascript:void(0)" class="btn btn-inverse-primary btn-sm edit-proposal btn-loading" data-pid="<?php echo esc_attr($result->id ); ?>" > <i class="far fa-edit"></i> <?php echo esc_html__( 'Edit', 'khebrat_theme' ); ?><span class="bubbles"> <i class="fa fa-circle" aria-hidden="true"></i> <i class="fa fa-circle" aria-hidden="true"></i> <i class="fa fa-circle" aria-hidden="true"></i> </span></a>
						  
						  <a href="javascript:void(0)" class="btn btn-inverse-danger btn-sm remove_proposal" data-pid="<?php echo esc_attr($result->id ); ?>" data-status="remove"> <i class="far fa-times-circle"></i> <?php echo esc_html__( 'Remove', 'khebrat_theme' ); ?></a>
					  </span> 
				  </div>
				</div>
            <?php
