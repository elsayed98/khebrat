        ...
        <div class="card-body">
         ...
         <div class="pro-coulmn">
            ...
            <?php if($result->status != "2" && $result->status != "4" ){ ?>
						  <a href="javascript:void(0)" class="btn btn-inverse-primary btn-sm change-invite-status btn-loading" data-status ="accept" data-fid = "<?php echo esc_attr($freelancer_id ); ?>" data-pid="<?php echo esc_attr($result->project_id ); ?>"  data-offer-id ="<?php  echo $result->id ?>" > <i class="far fa-edit"></i> <?php echo esc_html__( 'Accept', 'khebrat_theme' ); ?><span class="bubbles"> <i class="fa fa-circle" aria-hidden="true"></i> <i class="fa fa-circle" aria-hidden="true"></i> <i class="fa fa-circle" aria-hidden="true"></i> </span></a>
            <?php  } ?>
	
              <?php if($result->status != "3" && $result->status != "4" ){ ?>
						  <a href="javascript:void(0)" class="btn btn-inverse-danger btn-sm change-invite-status" data-status ="reject" data-fid = "<?php echo esc_attr($freelancer_id ); ?>" data-pid="<?php echo esc_attr($result->project_id ); ?>"  data-offer-id ="<?php echo $result->id ?>"> <i class="far fa-times-circle"></i> <?php echo esc_html__( 'Reject', 'khebrat_theme' ); ?></a>
                     <?php  } ?>
					  </span> 
				  </div>
				</div>
