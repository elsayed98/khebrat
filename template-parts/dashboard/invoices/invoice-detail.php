		  ...
		  <div class="d-flex justify-content-between flex-wrap">
			<div class="d-flex align-items-end flex-wrap">
			  <div class="mr-md-3 mr-xl-5">
				<h2><?php echo esc_html__('Invoices Detail','khebrat_theme'); ?></h2>
		...
		<div class="col-md-7 grid-margin stretch-card">
		  <div class="card mb-4">
			<div class="card-body">
					...
					<div class="row">
					  <div class="col-lg-6 col-xl-6 col-xs-12 col-md-6 col-sm-6">
						<div class="order-invoice-company">
						  ...
						  ?>
						  <p> <b><?php echo esc_html__( 'Date:', 'khebrat_theme' ) ?></b>
					  ...
					  <div class="col-lg-6 col-xl-6 col-xs-12 col-md-6 col-sm-6">
						<div class="order-invoice-to">
						  <h3 class="order-invoice-to-name"><?php echo esc_html__( 'Invoice', 'khebrat_theme' ) ?></h3>
						  <?php
						  if ( $emp_address != '' ) {
							?>
						  <address class="order-invoice-to-info">
						  ...
						  if ( $order_status == 'completed' ) {
							...
							$status_text = esc_html__( 'Completed', 'khebrat_theme' );
						  } else if ( $order_status == 'processing' ) {
							$badge_color = 'btn-inverse-primary';
							$status_text = esc_html__( 'Processing', 'khebrat_theme' );
						  } else if ( $order_status == 'pending' ) {
							$badge_color = 'btn-inverse-warning';
							$status_text = esc_html__( 'Pending', 'khebrat_theme' );
						  } else if ( $order_status == 'on-hold' ) {
							$badge_color = 'btn-inverse-dark';
							$status_text = esc_html__( 'On Hold', 'khebrat_theme' );
						  } else if ( $order_status == 'cancelled' ) {
							$badge_color = 'btn-inverse-secondary';
							$status_text = esc_html__( 'Cancelled', 'khebrat_theme' );
						  } else if ( $order_status == 'refunded' ) {
							$badge_color = 'btn-inverse-info';
							$status_text = esc_html__( 'Refunded', 'khebrat_theme' );
						  } else if ( $order_status == 'failed' ) {
							$badge_color = 'btn-inverse-danger';
							$status_text = esc_html__( 'Failed', 'khebrat_theme' );
						  }
						  ?>
						  <p><b><?php echo esc_html__( 'Invoice', 'khebrat_theme' ) ?> #<?php echo esc_html($oder_id); ?></b> </p>
						  <p class="order-invoice-status"> <b><?php echo esc_html__( 'Status:', 'khebrat_theme' ) ?></b> <span class="paid <?php echo esc_html($badge_color); ?>"> <?php echo esc_html($status_text); ?></span></p>
						</div>
					  </div>
					</div>
				  </div>
					  ...
					  <div class="table-responsive">
						<table class="table order-invoice-items">
						  <thead>
							<tr>
							  <th>#</th>
							  <th><?php echo esc_html__( 'Product', 'khebrat_theme' ) ?></th>
							  <th> <?php echo esc_html__( 'Amount', 'khebrat_theme' ) ?></th>
							</tr>
						  </thead>
						  <tbody>
							<tr>
						...
						<div class="order-invoice-footer-total">
						  <div class="table-responsive">
							<table class="table">
							  <tbody>
								<tr>
								  <td><?php echo esc_html__( 'Total:', 'khebrat_theme' ) ?></td>
			  ...
			  <div class="col-md-12"> <a href="javascript:void(0)" class="btn btn-theme pull-right " onclick="printDiv('printableArea')"><?php echo esc_html__( 'Print Invoice', 'khebrat_theme' ) ?></a> </div>
			</div>
		  </div>
		</div>
	  </div>
