      ...
      <div class="d-flex justify-content-between flex-wrap">
        <div class="d-flex align-items-end flex-wrap">
          <div class="mr-md-3 mr-xl-5">
            <h2><?php echo esc_html__('Saved Projects','khebrat_theme').esc_html(' ('. $total_count.')');?></h2>
						...
						while ( $the_query->have_posts() ) 
						{
							...
							?>
							  <div class="pro-box">
								...
								<div class="pro-coulmn"><a href="javascript:void(0)" class="btn btn-danger delete_fav_project" data-post-id="<?php echo esc_html($pid); ?>"> <?php echo esc_html__( 'Remove ', 'khebrat_theme' ); ?> </a></div>
							  </div>
