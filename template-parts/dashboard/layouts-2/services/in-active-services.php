      ...
      <div class="card mb-4">
        <div class="card-body">
          <div class="pro-section">
           ...
           <a href="javascript:void(0)" class="btn btn-inverse-success btn-sm cancel_service" data-pid="<?php echo esc_attr($sid); ?>" data-status="active"> <i class="far fa-times-circle"></i> <?php echo esc_html__( 'Make active', 'khebrat_theme' ); ?>
         </a> 
