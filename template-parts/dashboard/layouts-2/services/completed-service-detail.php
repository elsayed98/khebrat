                  ...
                  <div class="d-flex justify-content-between flex-wrap">
                    <div class="d-flex align-items-end flex-wrap">
                      <div class="mr-md-3 mr-xl-5">
                        <h2><?php echo esc_html__('Completed Service Detail','khebrat_theme');?></h2>
                                ...
                                if ( $result )
                                {
									...
									<div class="pro-box">
										...
										<div class="pro-coulmn buyer-detail">
											...
											<span class="service_start_date"> <?php echo esc_html__( 'Started on ', 'khebrat_theme' ).' '.date_i18n( get_option( 'date_format' ), strtotime( esc_html($result[0]['timestamp']))); ?></span>
										</div>
										<div class="pro-coulmn completed-status">
											<i class="fas fa-check-circle"></i>
											<div>
												<span class=""> <?php echo esc_html__( 'Completed ', 'khebrat_theme' ); ?> </span>
												<small> <?php echo esc_html__( 'on ', 'khebrat_theme' ).date_i18n( get_option( 'date_format' ), strtotime( $result[0]['status_date'] ) ); ?> </small>
											</div>
										</div>
									</div>
									<?php
