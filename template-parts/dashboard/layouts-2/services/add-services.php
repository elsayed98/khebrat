        ...
        <div class="notch"></div>
              ...
              <div class="d-flex justify-content-between flex-wrap">
                <div class="d-flex align-items-end flex-wrap">
                  <div class="mr-md-3 mr-xl-5">
                    <h2><?php echo esc_html__('Add New Service ','khebrat_theme'); ?></h2>
          ...
          <div class="row">
            <div class="col-xl-8 col-lg-12 col-md-12 grid-margin stretch-card">
                ...
                <div class="card mb-4">
                    <div class="card-body">
                      ...
                      <div class="form-row">
                        <div class="form-group col-md-6">
                          <label><?php echo esc_html__('Service Title ','khebrat_theme'); ?></label>
                          <input type="text" class="form-control" name="services_title" value="<?php echo esc_attr($post->post_title); ?>" <?php if(fl_framework_get_options('service_title') == 1){ ?>required data-smk-msg="<?php echo esc_attr__('Please give nice title to the service','khebrat_theme'); }?>">
                        </div>
                          <div class="form-group col-md-6">
                              <label for="service_price_prepend"><?php echo esc_html__('Price','khebrat_theme');?></label>
                              <div class="input-group">
                                  <div class="input-group-prepend">
                                    <span class="input-group-text" id="service_price_prepend"><?php echo $khebrat_theme_options['fl_currency'] ;?></span>
                                  </div>
                                  <input type="number" class="form-control" aria-describedby="service_price_prepend" id="service_price_prepend" name="service_price" value="<?php echo esc_attr(get_post_meta( $sid, '_service_price', true )); ?>"  <?php if(fl_framework_get_options('service_price') == 1){ ?>required data-smk-msg="<?php echo esc_attr__('Provide service price','khebrat_theme'); }?>" data-smk-type="number">
                              </div>
                          </div>
                    ...
                    <div class="form-row">
                    	<?php
							...
							else
							{
								...
								{
									$cat_check = 'required data-smk-msg="'.esc_attr__('Please select category','khebrat_theme').'"';	
								}
								?>
								<div class="form-group col-md-6">
							...
							else
							{
								...
								{
									$eng_level_check = 'required data-smk-msg="'.esc_attr__('Please select english level','khebrat_theme').'"';	
								}
								?>
								<div class="form-group col-md-6">
								  ...
								  $english_taxonomies = exertio_get_terms('services-english-level');
									if ( !empty($english_taxonomies) )
									{
										...
										$english .= '<option value=""> '. __( "English Level", "khebrat_theme" ) .'</option>';
                    ...
                    <div class="form-row">
						...
						else
						{
							...
							{
								$response_time_check = 'required data-smk-msg="'.esc_attr__('Please select response time','khebrat_theme').'"';	
							}
							?>
							<div class="form-group col-md-6">
							  <label><?php echo esc_html__('Response Time ','khebrat_theme'); ?></label>
							  <?php
							  $response_taxonomies = exertio_get_terms('response-time');
								if ( !empty($response_taxonomies) )
								{
									...
									$response .= '<option value=""> '. __( "Response Time ", "khebrat_theme" ) .'</option>';
							...
							?>
							<p><?php echo esc_html__('What will be the responce time to customer queries.','khebrat_theme'); ?></p>
							</div>
							<?php
						}
						...
						else
						{
							...
							{
								$delivery_time_check = 'required data-smk-msg="'.esc_attr__('Please select delivery time','khebrat_theme').'"';	
							}
							?>
							<div class="form-group col-md-6">
							  <label><?php echo esc_html__('Delivery Time ','khebrat_theme'); ?></label>
							  <?php
							  $delivery_taxonomies = exertio_get_terms('delivery-time');
								if ( !empty($delivery_taxonomies) )
								{
									...
									$delivery .= '<option value=""> '. __( "Delivery Time ", "khebrat_theme" ) .'</option>';
                      ...
                      <div class="form-row">
						...
						else
						{
							...
							{
								$location_check = 'required data-smk-msg="'.esc_attr__('Please select location','khebrat_theme').'"';	
							}
							?>
							<div class="form-group col-md-6">
                ...
                <div class="card mb-4">
                    <div class="card-body">
                    	<h4 class="card-title"><?php echo esc_html__('Services Detail','khebrat_theme'); ?></h4>
                        <div class="form-row">
				...
				?>
					<div class="card mb-4">
						<div class="card-body yt_card">
							<h4 class="card-title"><?php echo esc_html__('Youtube Video Links','khebrat_theme'); ?></h4>
								<div class="form-row">
								<div class="col-md-12">
									...
									<a href="javascript:void(0);" class="add_youtube_more btn btn-theme" title="Add field">
										<?php echo __( "Add More", 'khebrat_theme' ); ?>
									</a>
									<p><?php echo __( "Please provide YouTube video URLs Only.", "khebrat_theme" ); ?></p>
								</div>
							</div>
						   </div>
					</div>
                ...
                <div class="card mb-4">
                  <?php  $pro_img_id = get_post_meta( $sid, '_service_attachment_ids', true );?>
                    <div class="card-body project-attachments">
                      ...
                      <div class="form-row">
                            <div class="form-group col-md-12"> 
                                <label><?php echo __( "Want to upload attachments?", "khebrat_theme" ); ?></label> 
                        ...
                        <script>
                          ...
                          <div class="form-row">
                            <div class="form-group col-md-12">
                              ...
                              <input type="text" class="form-control" name="services_address" id="searchMapInput" value="<?php echo get_post_meta($sid, '_service_address', true); ?>" <?php if(fl_framework_get_options('services_address') == 1){ ?>required data-smk-msg="<?php echo esc_attr__('Please provide address','khebrat_theme'); }?>">
                            ...
                            <div class="col-md-12">
                            	<div class="submit-button-box">
                                    <div class="featured-box">
										...
										{
											?>
											<div class="pretty p-switch p-fill <?php echo esc_attr($feature_tooltip_class) ?>" <?php echo esc_attr($feature_tooltip); ?>  data-pt-position="top" data-pt-scheme="black" data-pt-title="<?php echo esc_attr__('Already Featured','khebrat_theme'); ?>">
                            	...
                            	<div class="submit-button-box">
                                    <button type="button" class="btn btn-theme btn-loading" id="fl_services_btn" data-post-id="<?php echo esc_attr($sid) ?>">
                                            <?php 
												...
												{
													echo esc_html__('Publish Service','khebrat_theme');
												}
												else
												{
													echo esc_html__('Update Service','khebrat_theme');
												}
											?>
            ...
            <div class="col-xl-4 col-lg-12 col-md-12 grid-margin stretch-card">
                <div class="card mb-4">
                        <div class="card-body side-addons">
                            <h4 class="card-title"><?php echo esc_html__('Services Addons','khebrat_theme'); ?></h4>
                            <div class="form-row">
                                <div class="col-md-12">
                                    <?php
									if(isset($addons) && empty($addons))
									{
										echo '<p>'.esc_html__('No Addon Available','khebrat_theme').'</p>';
									}
                                    ...
                                    ?>
                                        <div class="addon-box">
                                            ...
                                            <div class="addon-meta">
                                                ...
                                                <span class="addon-price"> <span><?php echo esc_html__('Addon Price ','khebrat_theme'); ?></span> <?php echo fl_price_separator(get_post_meta( $addon_id, '_addon_price', true )); ?></span>
					...
					?>
						<div class="card mb-4">
							<div class="card-body side-faqs">
								<h4 class="card-title"><?php echo esc_html__('Add FAQs','khebrat_theme'); ?></h4>
								<div class="form-row">
									<div class="col-md-12">
												...
												if(!empty($service_faqs))
												{
													...
													if (is_array($faqs))
													{
														foreach($faqs as $faq)
														{
															?>
															<div class="faqs-box">
																<h4><?php echo esc_html__('FAQ No','khebrat_theme'); ?></h4>
                                        ...
                                        <p><?php echo __( "You can rearrange and add multiple FAQ's", "khebrat_theme" ); ?></p>
									</div>
								</div>
							</div>
						</div>
