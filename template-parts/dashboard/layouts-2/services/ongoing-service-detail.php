                                ...
                                if ( $result )
                                {
                                        ...
                                        <div class="pro-box">
                                            ...
                                            <div class="pro-coulmn buyer-detail">
                                                ...
                                                <span class="service_start_date"> <?php echo esc_html__( 'Purchased on ', 'khebrat_theme' ).' '.date_i18n( get_option( 'date_format' ), strtotime( esc_html($result[0]['timestamp']))); ?></span>
                                            </div>
                                          </div>
