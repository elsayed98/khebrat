                ...
                <div class="card-body">
                    <div class="pro-section">
                        <div class="pro-box heading-row">
                            ...
                            <div class="pro-coulmn"><?php echo esc_html__('Password', 'khebrat_theme') ?> </div>
                            <div class="pro-coulmn"><?php echo esc_html__('Duration', 'khebrat_theme') ?> </div>
                            <div class="pro-coulmn"><?php echo esc_html__('Scheduled', 'khebrat_theme') ?> </div>   
                        </div>
                        <?php
                                            ...
                                            if ($meeting_id != '') {
                                                ...
                                                <div class="pro-box">
                                                    <div class="pro-coulmn pro-title">
                                                        ...
                                                        <span class="pro-btns">
                                                            <a href="<?php echo esc_attr($join_url); ?>" class="btn btn-inverse-primary btn-sm"> <i class="far fa-phone-alt"></i> <?php echo esc_html__('Join Meeting', 'khebrat_theme'); ?></a>
