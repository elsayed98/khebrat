	  ...
	  <div class="d-flex justify-content-between flex-wrap align-items-center">
		<div class="d-flex flex-wrap flex-column">
		  <div class="mr-md-3 mr-xl-5">
			<h2><?php echo esc_html__('Welcome back Freelancer', 'khebrat_theme' ); ?></h2>
		  </div>
				...
				<div class="col-md-6 col-lg-6 col-xl-3">
					<div class="info-boxes">
						<div class="metric">
							...
							<p>
								<span class="title"><?php echo esc_html__('Services Offered', 'khebrat_theme' ); ?></span>
								<span class="number"><?php echo esc_html($active_services); ?></span>
							</p>
						</div>
						<p class="matric-bottom"> <a href="<?php echo esc_url(get_the_permalink());?>?ext=all-services"><?php echo esc_html__('View Detail', 'khebrat_theme' ); ?> <i class="fas fa-arrow-right"></i></a></p>
					</div>
				</div>
				<div class="col-md-6 col-lg-6 col-xl-3">
					<div class="info-boxes">
						<div class="metric">
							...
							<p>
								<span class="title"><?php echo esc_html__(' Completed Services', 'khebrat_theme' ); ?></span>
								<span class="number"><?php echo esc_html($completed_services); ?></span>
							</p>
						</div>
						<p class="matric-bottom"> <a href="<?php echo esc_url(get_the_permalink());?>?ext=completed-services"> <?php echo esc_html__('View Detail', 'khebrat_theme' ); ?><i class="fas fa-arrow-right"></i></a></p>
					</div>
				</div>
				<div class="col-md-6 col-lg-6 col-xl-3">
					<div class="info-boxes">
						<div class="metric">
							...
							<p>
								<span class="title"><?php echo esc_html__('in Queue Services', 'khebrat_theme' ); ?></span>
								<span class="number"><?php echo esc_html($ongoing_services); ?></span>
							</p>
						</div>
						<p class="matric-bottom"> <a href="<?php echo esc_url(get_the_permalink());?>?ext=ongoing-services"><?php echo esc_html__('View Detail', 'khebrat_theme' ); ?> <i class="fas fa-arrow-right"></i></a></p>
					</div>
				</div>
				<div class="col-md-6 col-lg-6 col-xl-3">
					<div class="info-boxes">
						<div class="metric">
							...
							<p>
								<span class="title"><?php echo esc_html__('Reviews', 'khebrat_theme' ); ?></span>
								<span class="number"><?php echo esc_html($rating); ?></span>
							</p>
						</div>
						<p class="matric-bottom"> <a href="<?php echo esc_url(get_the_permalink());?>?ext=my-ratings"><?php echo esc_html__('View Detail', 'khebrat_theme' ); ?> <i class="fas fa-arrow-right"></i></a></p>
					</div>
				</div>
			</div>
		</div>
	...
	<div class="row">
		<div class="col-xl-8 col-lg-12 col-md-12 stretch-card">
		  <div class="card  grid-margin">
			...
			<div class="card grid-margin all-proposals">
				<div class="card-body">
				  <h4 class="card-title"> <?php echo esc_html__('Recent Purchased Services', 'khebrat_theme' ); ?></h4>
				  <div class="pro-section">
					  <div class="pro-box heading-row">
						<div class="pro-coulmn pro-title"><?php echo esc_html__( 'Service detail', 'khebrat_theme' ); ?></div>
						...
						<?php
								...
								{									
									...
									$proposals_html .= '<div class="pro-box">
										<div class="pro-coulmn pro-title">
											<span class="img"><a href="'.esc_url(get_permalink($buyer_id)).'">'.$employer_img.'</a></span> <span class="name"><a href="'.esc_url(get_permalink($buyer_id)).'">'.$employer_name.'</a></span>'.esc_html__( 'has purchased ', 'khebrat_theme' ).'<span class="project_name"><a href="'.esc_url(get_permalink($service_id)).'">'.$service_name.'</a></span>
							...
							else
							{
								...
								<div class="nothing-found">
									...
									<h3><?php echo esc_html__( 'Sorry!!! No Recent Purchases', 'khebrat_theme' ) ?></h3>
								</div>
								<?php	
							}
						?>
		...
		<div class="col-xl-4 col-lg-12 col-md-12 stretch-card">
			<div class="card grid-margin most-viewed-widget">
				<div class="card-body">
					<h4 class="card-title"><?php echo esc_html__('Most Viewed Services', 'khebrat_theme' ); ?></h4>
			...
			<div class="card grid-margin  current-package-widget">
				<div class="card-body">
				  <h4 class="card-title"><?php echo esc_html__('Current Plan Detail', 'khebrat_theme' ); ?></h4>
					<p class="view-more-btn"> <a href="<?php echo esc_url(get_the_permalink(fl_framework_get_options('freelancer_package_page'))); ?>" target="_blank"> <?php echo esc_html__(' View Plans ', 'khebrat_theme' ); ?></a></p>
					<?php
					
						$project_credits = get_post_meta( $freelancer_id, '_project_credits', true );
						$project_credits_text = isset( $project_credits) && $project_credits == -1 ? esc_html__(' Unlimited ', 'khebrat_theme' ) : $project_credits;
					
						$simple_services = get_post_meta( $freelancer_id, '_simple_services', true );
						$simple_services_text = isset( $simple_services) && $simple_services == -1 ? esc_html__(' Unlimited ', 'khebrat_theme' ) : $simple_services;
					
						$simple_services_expiry = get_post_meta( $freelancer_id, '_simple_service_expiry', true );
						$simple_services_expiry_text = isset( $simple_services_expiry) && $simple_services_expiry == -1 ? esc_html__(' Never Expire ', 'khebrat_theme' ) : $simple_services_expiry.esc_html__(' Days ', 'khebrat_theme' );

						$featured_services = get_post_meta( $freelancer_id, '_featured_services', true );
						$featured_services_text = isset( $featured_services) && $featured_services == -1 ? esc_html__(' Unlimited ', 'khebrat_theme' ) : $featured_services;

						$featured_services_expiry = get_post_meta( $freelancer_id, '_featured_services_expiry', true );
						$featured_services_expiry_text = isset( $featured_services_expiry) && $featured_services_expiry == -1 ? esc_html__(' Never Expire ', 'khebrat_theme' ) : $featured_services_expiry.esc_html__(' Days ', 'khebrat_theme' );
						...
						$package_expiry_text = isset( $freelancer_package_expiry_date) && $freelancer_package_expiry_date == -1 ? esc_html__(' Never Expire ', 'khebrat_theme' ) : date_i18n( get_option( 'date_format' ), strtotime( $freelancer_package_expiry_date  ));

						$freelancer_is_featured = get_post_meta( $freelancer_id, '_freelancer_is_featured', true );
						$freelacner_featured_text = isset( $freelancer_is_featured) && $freelancer_is_featured > 0 ? esc_html__('Yes', 'khebrat_theme' ) : esc_html__('No', 'khebrat_theme' );


                        $freelancer_listing_bump = get_post_meta($freelancer_id, '_freelancer_listing_bump', true);

                        $freelancer_listing_bump = isset( $freelancer_listing_bump) && $freelancer_listing_bump == -1 ? esc_html__(' Unlimited ', 'khebrat_theme' ) : $freelancer_listing_bump;
					...
					if(isset($simple_services) && $simple_services != '' && $freelancer_package_expiry_date != '')
					{
						...
						?>
							<ul>
								<li><i class="far fa-check-square"></i> <?php echo '<span>'.esc_html__('Project Credits: ', 'khebrat_theme' ).'</span>'.esc_html($project_credits_text); ?> </li>
								<li><i class="far fa-check-square"></i> <?php echo '<span>'.esc_html__('Services Allowed: ', 'khebrat_theme' ).'</span>'.esc_html($simple_services_text); ?> </li>
								<li><i class="far fa-check-square"></i> <?php echo '<span>'.esc_html__('Service Expiry: ', 'khebrat_theme' ).'</span>'.esc_html($simple_services_expiry_text); ?> </li>
								<li><i class="far fa-check-square"></i> <?php echo '<span>'.esc_html__('Featured Services: ', 'khebrat_theme' ).'</span>'.esc_html($featured_services_text); ?> </li>
								<li><i class="far fa-check-square"></i> <?php echo '<span>'.esc_html__('Featured Services Expiry: ', 'khebrat_theme' ).'</span>'.esc_html($featured_services_expiry_text); ?> </li>
								<li><i class="far fa-check-square"></i> <?php echo '<span>'.esc_html__('Bump Up Services: ', 'khebrat_theme' ).'</span>'.esc_html($freelancer_listing_bump); ?> </li>

								<li><i class="far fa-check-square"></i> <?php echo '<span>'.esc_html__('Featured Profile: ', 'khebrat_theme' ).'</span>'.esc_html($freelacner_featured_text); ?> </li>
								<li><i class="far fa-check-square"></i> <?php echo '<span>'.esc_html__('Package Expiry: ', 'khebrat_theme' ).'</span>'.esc_html($package_expiry_text ); ?> </li>
							</ul>
						<?php
						}
						else
						{
							echo '<p>'.esc_html__(' Your current package has expired', 'khebrat_theme' ).'</p>';
						}
					}
					else
					{
