					  ...
					  <div class="d-flex justify-content-between flex-wrap">
						<div class="d-flex align-items-end flex-wrap">
						  <div class="mr-md-3 mr-xl-5">
							<h2><?php echo esc_html__('Dispute Details','khebrat_theme');?></h2>
                      ...
                      if(get_post_status( $dispute_id )  == "pending"){  ?>
                        <div class="card mb-4">
                         <div class="card-body">
                          ...
                          <div class="project-history">
                                    <h3><?php echo esc_html__( 'Waiting for admin approval', 'khebrat_theme' ); ?>         
                                    </h3>                    
                         </div>
                        </div>
                     </div>
				  ...
				  <div class="row">
                    <div class="col-xl-7 col-lg-12 col-md-12 grid-margin stretch-card">
                        <div class="card mb-4">
                            <div class="card-body">
                                <div class="project-history">
                                    <h3><?php echo esc_html__( 'Dispute History', 'khebrat_theme' ); ?></h3>
                                    <div class="history-body">
                                        <div class="history-chat-body">
                                            ...
                                            {
                                                ?>
                                                <p class="text-center"><?php echo esc_html__( 'No messgae found', 'khebrat_theme' ); ?></p>
                                                <?php	
                                            }
                                            ?>
                                        </div>
                                            ...
                                            <form id="send_himstory_msg">
                                                <div class="form-row">
                                                    <div class="form-group col-md-12">
                                                        <textarea name="dispute_msg_text" id="" class="form-control" placeholder="<?php echo esc_attr__('Write your message here....','khebrat_theme'); ?>" required data-smk-msg="<?php echo esc_attr__('Please provide message to send','khebrat_theme'); ?>"></textarea>
                                                    </div>
                                                </div>
                                                <div class="form-row">
                                                    <div class="form-group col-md-12">
                        ...
                        <div class="card mb-4">
                            <div class="card-body">
                                <div class="dispute-box1">
									<h3><?php echo esc_html__( ' Admin Response', 'khebrat_theme' ); ?></h3>
                                    <p>
                                    	<?php 
										$admin_feedback ='';
										...
										{
											echo esc_html__( 'No Responce yet.', 'khebrat_theme' ); 
										}
										?>
                                    </p>
                                </div>
