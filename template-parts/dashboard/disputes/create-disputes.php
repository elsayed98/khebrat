		  ...
		  <div class="d-flex justify-content-between flex-wrap">
			<div class="d-flex align-items-end flex-wrap">
			  <div class="mr-md-3 mr-xl-5">
				<h2><?php echo esc_html__('My Disputes','khebrat_theme'); ?></h2>
			...
			<div class="d-flex justify-content-between align-items-end flex-wrap">
                <button class="btn btn-theme-secondary mt-2 mr-1 mt-xl-0" data-toggle="modal" data-target="#dispute-modal-service"><?php echo esc_html__('Create Service Dispute','khebrat_theme'); ?></button>
                <button class="btn btn-theme-secondary mt-2 mt-xl-0" data-toggle="modal" data-target="#dispute-modal"><?php echo esc_html__('Create Project Dispute','khebrat_theme'); ?></button>
			</div>
		  </div>
		</div>
	  </div>
        ...
        <div class="card-body">
          <div class="pro-section">
            <div class="pro-box heading-row">
              <div class="pro-coulmn"><?php echo esc_html__( 'Dispute title', 'khebrat_theme' ); ?> </div>
              <div class="pro-coulmn"><?php echo esc_html__( 'Project/Services', 'khebrat_theme' ); ?> </div>
            ...
            <div class="pro-box">
              ...
              <div class="pro-coulmn">
                ...
                if($post_status == 'pending'){
                  $status  =  esc_html__('Pending', 'khebrat_theme');
            ...
            <div class="nothing-found"> <img src="<?php echo get_template_directory_uri() ?>/images/dashboard/nothing-found.png" alt="<?php echo get_post_meta($alt_id, '_wp_attachment_image_alt', TRUE); ?>">
              <h3><?php echo esc_html__( 'Sorry!!! No Dispute Found', 'khebrat_theme' ) ?></h3>
            </div>
            <?php
            }
            ?>
          ...
          <div class="deposit-box card">
            <div class="depoist-header">
              ...
              <div class="deposit-header-text">
                <h3> <?php echo esc_html__('Project Dispute ','khebrat_theme'); ?></h3>
                <p><?php echo esc_html__('Provide detail as much as you can','khebrat_theme'); ?></p>
              </div>
            </div>
              ...
              <form id="dispute-project-form">
                <div class="form-row">
                  <div class="form-group col-md-12">
                    <label> <?php echo esc_html__('Select Project','khebrat_theme'); ?></label>
                    <?php echo fl_get_all_project_services(); ?> </div>
                  <div class="form-group col-md-12">
                    <label> <?php echo esc_html__('Tell us what your dispute is about','khebrat_theme'); ?></label>
                    <input type="text" class="form-control" name="dispute_title" required data-smk-msg="<?php echo esc_attr__('This field is required','khebrat_theme'); ?>" >
                  </div>
                  <div class="form-group col-md-12">
                    <label> <?php echo esc_html__('Description','khebrat_theme'); ?></label>
                    <textarea class="form-control" name="dispute_description" rows="3" required data-smk-msg="<?php echo esc_attr__('This field is required','khebrat_theme'); ?>"></textarea>
                    <p><?php echo esc_html__(' Write brief description here','khebrat_theme'); ?></p>
                  </div>
                </div>
              </form>
            </div>
            <div class="deposit-footer">
              <button type="button" id="dispute-project-btn" class="btn-loading"> <?php echo esc_html__('Submit Dispute','khebrat_theme'); ?>
                    ...
                    <div class="stretch-card">
                        <div class="deposit-box card">
                            <div class="depoist-header">
                                <div class="icon"> <img src="<?php echo get_template_directory_uri(); ?>/images/icons/law.png" alt="<?php echo esc_attr(get_post_meta($alt_id, '_wp_attachment_image_alt', TRUE)); ?>" class="img-fluid"> </div>
                                <div class="deposit-header-text">
                                    <h3> <?php echo esc_html__('Service Dispute ','khebrat_theme'); ?></h3>
                                    <p><?php echo esc_html__('Provide detail as much as you can','khebrat_theme'); ?></p>
                                </div>
                            </div>
                            <div class="deposit-body">
                                <form id="dispute-service-form">
                                    <div class="form-row">
                                        <div class="form-group col-md-12">
                                            <label> <?php echo esc_html__('Select Service','khebrat_theme'); ?></label>
                            ...
                            <div class="deposit-footer">
                                <button type="button" id="dispute-service-btn" class="btn-loading"> <?php echo esc_html__('Submit Dispute','khebrat_theme'); ?>
                                    <div class="bubbles"> <i class="fa fa-circle"></i> <i class="fa fa-circle"></i> <i class="fa fa-circle"></i> </div>
                                </button>
                                <input type="hidden" id="fl_dispute_nonce" value="<?php echo wp_create_nonce('fl_dispute_secure'); ?>"  />
                            </div>
