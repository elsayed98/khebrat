			  ...
			  <div class="d-flex justify-content-between flex-wrap">
				<div class="d-flex align-items-end flex-wrap">
				  <div class="mr-md-3 mr-xl-5">
					<h2><?php echo esc_html__('Freelancer Settings','khebrat_theme'); ?></h2>
								...
								<div class="row">
									<div class="col-3">
										<div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
											<a class="nav-link active" id="v-pills-payout-tab" data-toggle="pill" href="#v-pills-payout" role="tab" aria-controls="v-pills-home" aria-selected="true"><?php echo esc_html__('Payout Setting', 'khebrat_theme' ); ?></a>
										</div>
									</div>
									<div class="col-9">
											...
											<div class="tab-pane fade show active" id="v-pills-payout" role="tabpanel" aria-labelledby="v-pills-payout-tab">
												<div class="form-group inline-options">
													...
													<div class="heading-side">
														<label class="heading"><?php echo esc_html__('Enable Payout','khebrat_theme'); ?></label>
														<p><?php echo esc_html__('Turn this option ON if you want to enable auto payout. ', 'khebrat_theme' ); ?></p>
													</div>
										...
										<div class="submit-button">
											<button type="button" id="freelancer_setting_btn" class="btn btn-theme  btn-loading"> <?php echo esc_html__('Save Settings', 'khebrat_theme' ); ?>
