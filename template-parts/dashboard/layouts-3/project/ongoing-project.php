						...
						while ( $the_query->have_posts() ) 
						{
							...
							<div class="pro-box">
								...
								if( fl_framework_get_options('turn_project_messaging') == true)
								{
									?>
									<div class="pro-coulmn">
										<a href="<?php get_template_part( 'project-propsals' );?>?ext=ongoing-project-detail&project-id=<?php echo esc_html($pid); ?>" class="btn btn-theme-secondary"> <?php echo esc_html__( 'View Detail', 'khebrat_theme' ); ?> </a>
									</div>
									<?php
								}
								else
