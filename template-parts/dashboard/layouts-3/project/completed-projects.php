      ...
      <div class="d-flex justify-content-between flex-wrap">
        <div class="d-flex align-items-end flex-wrap">
          <div class="mr-md-3 mr-xl-5">
            <h2><?php echo esc_html__('Completed Projects','khebrat_theme');?></h2>
        ...
        <div class="card-body">
          <div class="pro-section">
              <div class="pro-box heading-row">
                ...
                <div class="pro-coulmn"><?php echo esc_html__( 'Assigned on', 'khebrat_theme' ) ?> </div>
							...
							?>
							  <div class="pro-box">
								...
								<div class="pro-coulmn">
									...
									{
										?>
									<a href="<?php get_template_part( 'project-propsals' );?>?ext=completed-project-detail&project-id=<?php echo esc_html($pid); ?>" class="btn btn-theme-secondary"> <?php echo esc_html__( 'View Detail', 'khebrat_theme' ); ?> </a>
										<?php
									}
									else
									{
