      ...
      <div class="d-flex justify-content-between flex-wrap">
        <div class="d-flex align-items-end flex-wrap">
          <div class="mr-md-3 mr-xl-5">
            <h2><?php echo esc_html__('Project Offers','khebrat_theme'); ?></h2>
        ...
        <div class="card-body">
          <div class="pro-section">
            ...
            <?php if($result->offer_Status != "2" && $result->offer_Status != "4" ){ ?>
						  <a href="javascript:void(0)" class="btn btn-inverse-primary btn-sm change-offer-status btn-loading" data-status ="accept" data-pid="<?php echo esc_attr($result->project_id ); ?>"  data-offer-id ="<?php  echo $result->id ?>" > <i class="far fa-edit"></i> <?php echo esc_html__( 'Accept', 'khebrat_theme' ); ?><span class="bubbles"> <i class="fa fa-circle" aria-hidden="true"></i> <i class="fa fa-circle" aria-hidden="true"></i> <i class="fa fa-circle" aria-hidden="true"></i> </span></a>
            <?php  } ?>
	
              <?php if($result->offer_Status != "3" && $result->offer_Status != "4"  && $result->offer_Status != "2"){ ?>
						  <a href="javascript:void(0)" class="btn btn-inverse-danger btn-sm change-offer-status" data-status ="reject" data-pid="<?php echo esc_attr($result->project_id ); ?>" data-status="remove"  data-offer-id ="<?php echo $result->id ?>"> <i class="far fa-times-circle"></i> <?php echo esc_html__( 'Reject', 'khebrat_theme' ); ?></a>
                     <?php  } ?>
					  </span> 
				  </div>
				</div>
