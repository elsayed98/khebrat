...
$saved_child_term = get_post_meta($pid, '_customer_location', true);
$saved_parent_term = '';
if ($saved_child_term) {
            ...
            <div class="card-body content-wrapper ">
                ...
                <form id="customer_form" class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control flatpickr" name="date_birth_id" value="<?php echo esc_attr(get_post_meta($pid, '_customer_date_birth', true)); ?>" placeholder="Enter date of birth" data-date-format="d m Y">
                    </div>

                    <!-- Gender -->
                    <div class="col-md-6">
                        <?php
                        $gender = get_post_meta($pid, '_customer_gender', true); // أو استخدم get_user_meta() إذا كان للحسابات
                        ?>
                        <label class="form-label"><?php echo esc_html__('تحديد الجنس', 'khebrat_theme'); ?><span class="text-danger">*</span></label>
                        <div class="d-flex gap-4">
                            <div class="form-check radio-bg-light">
                                <input class="form-check-input" type="radio" name="customer_gender" id="gender_male" value="0" <?php checked($gender, '0'); ?>>
                                <label class="form-check-label" for="gender_male"><?php echo esc_html__('ذكر', 'khebrat_theme'); ?></label>
                            </div>
                            <div class="form-check radio-bg-light">
                                <input class="form-check-input" type="radio" name="customer_gender" id="gender_female" value="1" <?php checked($gender, '1'); ?>>
