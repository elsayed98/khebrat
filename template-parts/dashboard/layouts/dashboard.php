	  ...
	  <div class="d-flex justify-content-between flex-wrap align-items-center">
		<div class="d-flex flex-wrap flex-column">
		  <div class="mr-md-3 mr-xl-5">
			<h2><?php echo esc_html__('Welcome back Employer', 'khebrat_theme' )?></h2>
		  </div>
				...
				<div class="col-md-6 col-lg-6 col-xl-3">
					<div class="info-boxes">
						<div class="metric">
							...
							<p>
								<span class="title"><?php echo esc_html__('Projects Posted', 'khebrat_theme' ); ?></span>
								<span class="number"><?php echo esc_html($project_count); ?></span>
							</p>
						</div>
						<p class="matric-bottom"> <a href="<?php echo esc_url(get_the_permalink());?>?ext=projects"><?php echo esc_html__('View Detail', 'khebrat_theme' ); ?> <i class="fas fa-arrow-right"></i></a></p>
					</div>
				</div>
				...
				<div class="col-md-6 col-lg-6 col-xl-3">
					<div class="info-boxes">
						<div class="metric">
							...
							<p>
								<span class="title"><?php echo esc_html__('Featured Projects', 'khebrat_theme' ); ?></span>
				...
				<div class="col-md-6 col-lg-6 col-xl-3">
					<div class="info-boxes">
						<div class="metric">
							...
							<p>
								<span class="title"><?php echo esc_html__('Ongoing Projects', 'khebrat_theme' ); ?></span>
								<span class="number"><?php echo esc_html($project_count_ongoing); ?></span>
							</p>
						</div>
						<p class="matric-bottom"> <a href="<?php echo esc_url(get_the_permalink());?>?ext=ongoing-project"><?php echo esc_html__('View Detail', 'khebrat_theme' ); ?> <i class="fas fa-arrow-right"></i></a></p>
					</div>
				</div>
				<div class="col-md-6 col-lg-6 col-xl-3">
					<div class="info-boxes">
						<div class="metric">
							...
							<p>
								<span class="title"><?php echo esc_html__('Completed Projects', 'khebrat_theme' ); ?></span>
								<span class="number"><?php echo esc_html($project_count_completed); ?></span>
							</p>
						</div>
						<p class="matric-bottom"> <a href="<?php echo esc_url(get_the_permalink());?>?ext=completed-projects"><?php echo esc_html__('View Detail', 'khebrat_theme' ); ?> <i class="fas fa-arrow-right"></i></a></p>
					</div>
				</div>
			</div>
		</div>
	...
	<div class="row">
		<div class="col-xl-8 col-lg-12 col-md-12 stretch-card">
		  <div class="card grid-margin">
			<div class="card-body">
			  <h4 class="card-title"><?php echo esc_html__('Profile Views', 'khebrat_theme' ); ?></h4>
			  <div class="chart-box"><canvas id="bar-chart" height="175"></canvas></div>         
			</div>
		  </div>
			<div class="card grid-margin all-proposals">
				<div class="card-body">
				  <h4 class="card-title"> <?php echo esc_html__('Recent Proposals', 'khebrat_theme' ); ?></h4>
				  <div class="pro-section">
					  <div class="pro-box heading-row">
						<div class="pro-coulmn pro-title"><?php echo esc_html__( 'Proposal detail', 'khebrat_theme' ); ?></div>
						<div class="pro-coulmn"><?php echo esc_html__( 'Cost', 'khebrat_theme' ); ?> </div>
					</div>
						<?php
							...
							if ( $result != null )
							{
								...
								foreach($result as $results)
								{
									...
									$posted_date = $results->updated_on;
											...
											{
												$project_cost .=  esc_html(fl_price_separator($results->proposed_cost));
												$project_cost .=  '<span class="protip" data-pt-title="'.esc_attr__('In ','khebrat_theme').$days_to_complete.__(' hours total will be  ','khebrat_theme'). fl_price_separator($days_to_complete*$results->proposed_cost).'" data-pt-position="top" data-pt-scheme="black"><i class="far fa-question-circle"></i></span>';
											}

									$proposals_html .= '<div class="pro-box">
										<div class="pro-coulmn pro-title">
											<span class="img"><a href="'.esc_url(get_permalink($freelancer_id)).'">'.$freelancer_img.'</a></span> <span class="name"><a href="'.esc_url(get_permalink($freelancer_id)).'">'.$freelancer_name.'</a></span>'.esc_html__( ' sent a proposal on ', 'khebrat_theme' ).'<span class="project_name"><a href="'.esc_url(get_permalink($project_id)).'">'.$project_name.'</a></span>
							...
							else
							{
								...
								<div class="nothing-found">
									...
									<h3><?php echo esc_html__( 'Sorry!!! No Proposals Found', 'khebrat_theme' ) ?></h3>
								</div>
								<?php	
							}
						?>
		...
		<div class="col-xl-4 col-lg-12 col-md-12 stretch-card">
			<div class="card grid-margin most-viewed-widget">
				<div class="card-body">
					<h4 class="card-title"><?php echo esc_html__('Most Viewed Projects', 'khebrat_theme' ); ?></h4>
									...
									while ( $most_listings->have_posts() )
									{
										...
										$project_cost = '';
											...
											else if($type == 'hourly' || $type == 2)
											{
												...
												$project_cost .=  '<span class="protip" data-pt-title="'.esc_attr__('For ','khebrat_theme').$estimated_hours.__(' hours total will be  ','khebrat_theme'). fl_price_separator($hourly_total_price).'" data-pt-position="top" data-pt-scheme="black"><i class="far fa-question-circle"></i></span>';
											}
									?>
											<li>
...
<!--													</div>-->
								...
								{
									//echo exertio_no_result_found('',__( 'No, States available', 'khebrat_theme' ));
									echo '<p>'.esc_html__(' No,stats available', 'khebrat_theme' ).'</p>';
								}
							?>
						</ul>
					</div>
				...
				<div class="card-body">
				  <h4 class="card-title"><?php echo esc_html__('Current Plan Detail', 'khebrat_theme' ); ?></h4>
					...
					<?php
                       ...
                       $employer_listing_bump = isset( $employer_listing_bump) && $employer_listing_bump == -1 ? esc_html__(' Unlimited ', 'khebrat_theme' ) : $employer_listing_bump;
                     
					
						$employer_is_featured = get_post_meta( $employer_id, '_employer_is_featured', true);
						$employer_featured_text = isset( $employer_is_featured) && $employer_is_featured > 0 ? esc_html__('Yes', 'khebrat_theme' ) : esc_html__('No', 'khebrat_theme' );
					if(isset($simple_project) && $simple_project != '')
					{
						...
						<ul>
							...
							<li><img src="<?php echo get_template_directory_uri(); ?>/images/dashboard/success.png" alt="<?php echo esc_attr(get_post_meta($img_id, '_wp_attachment_image_alt', TRUE)); ?>"> <?php echo '<span>'.esc_html__('Project Bump up: ', 'khebrat_theme' ).'</span>'.esc_html($employer_listing_bump); ?> </li>
