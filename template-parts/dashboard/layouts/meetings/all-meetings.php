            ...
            <div class="d-flex justify-content-between flex-wrap">
                <div class="d-flex align-items-end flex-wrap">
                    <div class="mr-md-3 mr-xl-5">
                        <h2><?php echo esc_html__('All Meetings', 'khebrat_theme') . esc_html(' (' . $total_count . ')'); ?></h2>
                ...
                <div class="card-body">
                    <div class="pro-section">
                        <div class="pro-box heading-row">
                            ...
                            <div class="pro-coulmn"><?php echo esc_html__('Meeting Topic', 'khebrat_theme') ?> </div>
                            <div class="pro-coulmn"><?php echo esc_html__('Meeting Duration', 'khebrat_theme') ?> </div>
                            <div class="pro-coulmn"><?php echo esc_html__('Meeting Time', 'khebrat_theme') ?> </div>
                        </div>
                        <?php
										...
										if (is_array($data_arr) && !empty($data_arr)) {
											...
											<div class="pro-box">
												<div class="pro-coulmn pro-title">
													...
													<span class="pro-btns">
														<a href="<?php echo esc_attr($meet_start_url); ?>" class="btn btn-inverse-primary btn-sm"> <i class="far fa-phone-alt"></i> <?php echo esc_html__('Start Meeting', 'khebrat_theme'); ?></a>
														<a href="javascript:void(0)" class="btn btn-inverse-warning btn-sm " id="meeting_deletion" data-pid="<?php echo esc_attr($job_id); ?>" data-meetid="<?php echo esc_attr($meeting_id); ?>" data-fl-id="<?php echo esc_attr($cand_id); ?>"> <i class="far fa-times-circle"></i> <?php echo esc_html__('Delete Meeting', 'khebrat_theme'); ?></a>
													</span>
												</div>
												...
												<div class="pro-coulmn">
													<?php
													echo esc_attr($meeting_duration) . esc_html(' Minutes', 'khebrat_theme');
													?>
												</div>
												<div class="pro-coulmn">
													<?php
