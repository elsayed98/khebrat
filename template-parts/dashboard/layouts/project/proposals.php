					  ...
					  <div class="d-flex justify-content-between flex-wrap">
						<div class="d-flex align-items-end flex-wrap">
						  <div class="mr-md-3 mr-xl-5">
							<h2><?php echo esc_html__('Proposals','khebrat_theme'); ?></h2>
						...
						<div class="card-body">
						  <div class="pro-section project-details">
							  <div class="pro-box">
								...
								<div class="pro-coulmn"><span class="btn btn-theme-secondary"> <?php echo esc_html__( 'Total Proposals', 'khebrat_theme' ).' ('.$total_count.')'; ?></span></div>
							  </div>
						  </div>
						   <div class="fr-project-bidding proposals-dashboard only-proposals">
									<?php
										...
										<div class="fr-project-box">
										  <h3><?php echo esc_html__( 'Proposals', 'khebrat_theme' ); ?></h3>
										</div>
										...
										if($results)
										{
											...
											foreach($results as $result)
											{
                                                ...
                                                if ($meeting_id == '') {
                                                    $meeting_btn = esc_html__('Create Meeting', 'khebrat_theme');
                                                } else {
                                                    $meeting_btn = esc_html__('Update Meeting', 'khebrat_theme');
                                                }
												?>
													  ...
													  <div class="fr-project-profile-details">
														...
														<div class="fr-project-user-details"> <a href="<?php  echo esc_url(get_permalink($result->freelancer_id)); ?>">
														  ...
														  <ul>
															...
															{
																if($khebrat_theme_options['zoom_meeting_btn'] == 1)
																{
																	?>
																	<!--ZOOM MEETING BUTTON-->
																	<span class="pro-btns">
														...
														<div class="fr-project-content-details">
															...
															?>
															<button type="button" class="btn btn-theme-secondary btn-loading" id="assign_project" data-pid="<?php echo esc_attr($project_id); ?>" data-fl-id="<?php echo esc_attr($result->freelancer_id); ?>"> <?php echo esc_html__( 'Hire Now', 'khebrat_theme' ); ?> <div class="bubbles"> <i class="fa fa-circle"></i> <i class="fa fa-circle"></i> <i class="fa fa-circle"></i> </div></button>
                                                           <?php 
                                                              if(fl_framework_get_options('allow_projects_offers')){
                                                                   ?>
                                                                 <button type="button" class="btn btn-theme-secondary btn-loading send_offer" id="send_offer" data-pid="<?php echo esc_attr($project_id); ?>" data-fl-id="<?php echo esc_attr($result->freelancer_id); ?>"  prop_id = <?php echo $proposal_id; ?> > <?php echo esc_html__( 'Send Offer', 'khebrat_theme' ); ?> <div class="bubbles"> <i class="fa fa-circle"></i> <i class="fa fa-circle"></i> <i class="fa fa-circle"></i> </div></button>
                                                            <?php
                                                              }
