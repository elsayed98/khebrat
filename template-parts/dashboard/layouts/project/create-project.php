...
if(!isset($_GET['pid']))
{
	...
	if(isset($is_prjects_paid) && $is_prjects_paid == 1)
	{
		...
		{
			echo exertio_redirect(get_the_permalink($khebrat_theme_options['emp_package_page']).'?ext=buy-package');
		}
	}
}
	$is_update = '';
				  ...
				  <div class="d-flex justify-content-between flex-wrap">
					<div class="d-flex align-items-end flex-wrap">
					  <div class="mr-md-3 mr-xl-5">
						<h2><?php echo esc_html__('Create Project','khebrat_theme'); ?></h2>
			  ...
			  <div class="row">
				<div class="col-xl-8 col-lg-12 col-md-12 grid-margin stretch-card">
                    ...
                    if(isset($khebrat_theme_options['projects_with_email_verified']) &&  $khebrat_theme_options['projects_with_email_verified'] == 0)
                    {
                        ...
                        if($is_verified != 1 || $is_verified == '')
                        {
                            { ?>
                                <div class="alert alert-danger fade show" role="alert">
                                    ...
                                    <div class="alert-text"><?php echo esc_html__('You are not allowed to create a project.please verify your email first.','khebrat_theme'); ?></div>
						...
						if(isset($khebrat_theme_options['create_msg']) && $khebrat_theme_options['create_msg'] != '')
						{
							?>
							<div class="card mb-4 info-box">
								<div class="card-body">
									<?php
									if(isset($khebrat_theme_options['create_icon']) && $khebrat_theme_options['create_icon'] != '')
									{
										echo '<i class="'.$khebrat_theme_options['create_icon'].'"></i>';
									}
									echo '<p>'.$khebrat_theme_options['create_msg'].'</p>';
									?>
								</div>
							</div>
							<?php
					...
					<form id="project_form" >
					  <div class="card mb-4">
						<div class="card-body">
						  <h4 class="card-title"><?php echo esc_html__('Basic Information','khebrat_theme'); ?></h4>
						  <div class="form-row">
							<div class="form-group col-md-12">
							  <label><?php echo esc_html__('Project Title','khebrat_theme'); ?></label>
							  <input type="text" class="form-control" name="project_name" value="<?php echo esc_attr($post->post_title); ?>" <?php if(fl_framework_get_options('project_title') == 1){ ?>required data-smk-msg="<?php echo esc_attr__('Please give title to your project','khebrat_theme'); } ?>">
							</div>
                              <input type="hidden" id="is_update" name="is_update" value="<?php echo esc_attr($is_update); ?>" />
                          </div>
						  <div class="form-row">
							<div class="form-group col-md-6">
								  <label><?php echo esc_html__('Category','khebrat_theme'); ?></label>
								   <?php 
								   $project_category = '';
									if(fl_framework_get_options('project_category') == 1)
									{
										$project_category = "required data-smk-msg='".esc_attr__("Please select suitable category","khebrat_theme")."'"; 
									}
							...
							else
							{
								?>
								<div class="form-group col-md-6">
								  <label><?php echo esc_html__('Freelancer Type','khebrat_theme'); ?></label>
								  <?php
								  
									$feelancer_type_chk = '';
									if(fl_framework_get_options('project_freelancer_type') == 1)
									{
										$feelancer_type_chk = "required data-smk-msg='".esc_attr__("Please select freelancer type","khebrat_theme")."'"; 
									}
								  $freelancer_taxonomies = exertio_get_terms('freelancer-type');
									if ( !empty($freelancer_taxonomies) )
									{
										...
										$freelancer .= '<option value=""> '. __( "Freelancer Type", "khebrat_theme" ) .'</option>';
						  ...
						  <div class="form-row">
							<div class="form-group col-md-6">
							  <label><?php echo esc_html__('Price type','khebrat_theme'); ?></label>
								<?php 
								...
								?>
								<select name="project_type" class="form-control general_select project-type" <?php if(fl_framework_get_options('project_cost') == 1){ ?>required data-smk-msg="<?php echo esc_attr__('Please select price type','khebrat_theme'); } ?>" >
									<option value=""> <?php echo esc_html__( "Select price type", "khebrat_theme" ); ?></option>
                                    <?php if(fl_framework_get_options('project_type_allowed') == 2 && (fl_framework_get_options('project_type_allowed') == 2)){ ?>
                                    <option value="2" <?php if($project_type== 'hourly' || $project_type== 2 ) {echo 'selected';} ?>><?php echo esc_html__('Hourly','khebrat_theme'); ?></option>
                                    <?php }?>
									<option selected value="1" <?php if($project_type== 'fixed' || $project_type== 1) {echo 'selected';} ?>><?php echo esc_html__('Fixed','khebrat_theme'); ?></option>
								</select>
							</div>

							<div class="form-group col-md-6 fixed-field" <?php echo esc_attr($hide); ?> >
                                <label for="project_cost_prepend"><?php echo esc_html__('Cost','khebrat_theme');?></label>
                                <div class="input-group">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text" id="project_cost_prepend"><?php echo $khebrat_theme_options['fl_currency'] ;?></span>
                                    </div>
                                    <input type="number" class="form-control" aria-describedby="project_cost_prepend" id="project_cost_prepend" name="project_cost" value="<?php echo esc_attr(get_post_meta($pid, '_project_cost', true));?>" <?php if(fl_framework_get_options('project_cost') == 1){ ?>required data-smk-msg="<?php echo esc_attr__('Please provide project cost in Numbers','khebrat_theme'); }?>" <?php echo esc_attr($not_disabled); ?> >
                                </div>
							</div>
							<div class="form-group col-md-6 hourly-field" <?php echo esc_attr($show); ?> >
                                <label for="project_cost_hourly_prepend"><?php echo esc_html__('Per Hour Price','khebrat_theme'); ?></label>
                                <div class="input-group">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text" id="project_cost_prepend"><?php echo $khebrat_theme_options['fl_currency'] ;?></span>
                                    </div>
                                    <input type="number" class="form-control" aria-describedby="project_cost_hourly_prepend" id="project_cost_hourly_prepend"  name="project_cost_hourly" value="<?php echo esc_attr(get_post_meta($pid, '_project_cost', true));?>" <?php if(fl_framework_get_options('project_cost') == 1){ ?>required data-smk-msg="<?php echo esc_attr__('Please provide per hour price','khebrat_theme'); }?>" <?php echo esc_attr($disabled); ?>>
                                </div>
							</div>
							<div class="form-group col-md-12 hourly-field" <?php echo esc_attr($show); ?>>
							  ...
							  <input type="text" class="form-control" name="estimated_hours" value="<?php echo esc_attr(get_post_meta($pid, '_estimated_hours', true));?>" <?php if(fl_framework_get_options('project_cost') == 1){ ?>required data-smk-msg="<?php echo esc_attr__('Please provide estimated hours','khebrat_theme'); }?>" <?php echo esc_attr($disabled); ?>>
							</div>
						  </div>
						  <div class="form-row">
							<?php
							...
							else
							{
								...
								{
									$duration_chk = 'required data-smk-msg="'.esc_attr__("Please select project duration","khebrat_theme").'"'; 
								}
							
							?>
								<div class="form-group col-md-6">
									<label><?php echo esc_html__('Project Duration','khebrat_theme'); ?></label>
								  <?php
									...
									if ( !empty($duration_taxonomies) )
									{
										...
										$duration .= '<option value=""> '. __( "Select Project Duration", "khebrat_theme" ) .'</option>';
							...
							else
							{
								...
								{
									$level_chk = 'required data-smk-msg="'.esc_attr__("Please select project level","khebrat_theme").'"'; 
								}
							
							?>
							<div class="form-group col-md-6">
								<label><?php echo esc_html__('Level','khebrat_theme'); ?></label>
								<?php
								...
								if ( !empty($level_taxonomies) )
								{
									...
									$level .= '<option value=""> '. __( "Select Project Level", "khebrat_theme" ) .'</option>';
							...
							else
							{
								...
								{
									$eng_level_chk = 'required data-smk-msg="'.esc_attr__("Please select english level","khebrat_theme").'"'; 
								}
								?>
								<div class="form-group col-md-6">
							...
							else
							{
								...
								{
									$location_chk = 'required data-smk-msg="'.esc_attr__("Please select location","khebrat_theme").'"'; 
								}
								?>
								<div class="form-group col-md-6">
									...
									<span class="remote-location-box">
										...
										<p> <?php echo esc_html__('Check this for remote location','khebrat_theme'); ?></p>
									</span>
								 </div>
								<?php
							}
						  ...
						  <?php
							...
							else
							{
								...
								{
									$skills_chk = 'required data-smk-msg="'.esc_attr__("Please select skills","khebrat_theme").'"'; 
								}
							
								?>
							  <div class="form-row">
								<div class="form-group col-md-12">
								  <label><?php echo esc_html__('Skills','khebrat_theme'); ?></label>
								  ...
								  $saved_skills = wp_get_post_terms($pid, 'skills', array( 'fields' => 'all' ));
									if ( !empty($skills_taxonomies) )
									{
										...
										$skill .= '<option value="" disabled> '. __( "Select required skills", "khebrat_theme" ) .'</option>';
							...
							else
							{
								...
								{
									$languages_chk = 'required data-smk-msg="'.esc_attr__("Please select skills","khebrat_theme").'"'; 
								}
					  ...
					  <div class="card mb-4">
						<div class="card-body">
						  <h4 class="card-title"><?php echo esc_html__('Project Detail','khebrat_theme'); ?></h4>
						  <div class="form-row">
								<div class="form-group col-md-12">                  	
									<label> <?php echo esc_html__('Description','khebrat_theme'); ?></label> 
									<textarea name="project_desc" class="form-control fl-textarea" id="" placeholder="<?php echo esc_attr__('description here','khebrat_theme'); ?>"><?php echo esc_html($post->post_content); ?></textarea>
								</div>
							</div>
						</div>
					  </div>
					  ...
					  <?php $pro_img_id = get_post_meta( $pid, '_project_attachment_ids', true ); ?>
						<div class="card-body project-attachments">
						  <h4 class="card-title"><?php echo esc_html__('Upload Attachments','khebrat_theme'); ?></h4>
						  <div class="form-row">
								<div class="form-group col-md-12"> 
									<label> <?php echo esc_html__('Want to upload attachments?','khebrat_theme'); ?></label> 
							...
							<div class="form-row img-wrapper" <?php echo esc_attr($display); ?>>
								<div class="form-group col-md-12">
									<div class="upload-btn-wrapper">
										<button class="btn btn-theme-secondary mt-2 mt-xl-0" type="button"><?php echo esc_html__('Upload attachments','khebrat_theme'); ?></button>
							...
							<div class="form-row" >
								...
								<p class="attachment_note"><?php echo esc_html__('Drag & drop to rearrange and press save button to apply.','khebrat_theme'); ?></p>
							</div>
					  ...
					  <?php
						...
						?>
						  <div class="card mb-4">
							<div class="card-body">
							  <h4 class="card-title"><?php echo esc_html__('Address Information','khebrat_theme'); ?></h4>  
						   <?php 
							...
							<script>
							  ...
							  <div class="form-row">
								<div class="form-group col-md-12">
								  ...
								  <input type="text" class="form-control" name="project_address" id="searchMapInput" value="<?php echo get_post_meta($pid, '_project_address', true); ?>" <?php if(fl_framework_get_options('project_address') == 1){ ?>required data-smk-msg="<?php echo esc_attr__('Please provide address','khebrat_theme'); }?>">
							...
							<div class="card-body">
									...
									<?php
										...
										if($is_featured == 0 )
										{
											...
											if(isset($featured_projects) && $featured_projects > 0 || $featured_projects == '-1' )
											{
												...
												<p> <?php echo esc_html__('جعل المشروع مميز','khebrat_theme'); ?></p>
											...
											else
											{
												...
												<div class="alert alert-warning fade show" role="alert">
													<div class="alert-icon"><i class="fas fa-exclamation-triangle"></i></div>
													<div class="alert-text"><?php echo esc_html__('Purchase package to mark your project featured.','khebrat_theme'); ?></div>
													<div class="alert-close">
														<a href="<?php echo esc_html(get_the_permalink(fl_framework_get_options('emp_package_page')));  ?>" class="btn btn-dark" target="_blank">
															<?php echo esc_html__('Buy Package','khebrat_theme'); ?>
														</a>
													</div>
												</div>
												<?php
										...
										{
											?>
											<h4><?php echo esc_html__('Already Featured','khebrat_theme');  ?></h4>
											<p><?php echo esc_html(fl_framework_get_options('mark_featured_desc'));  ?></p>
											<?php
										}
									?>
								...
								<button type="button" class="btn btn-theme" id="create_project_btn" data-post-id="<?php echo esc_attr($pid) ?>">
										<?php 
											...
											{
												echo esc_html__('Create Project','khebrat_theme');
											}
											else
											{
												echo esc_html__('Update Project','khebrat_theme');
											}
										?>
				...
				<div class="col-xl-4 col-lg-12 col-md-12 grid-margin stretch-card">
					<?php
					if(isset($khebrat_theme_options['tips_switch']) && $khebrat_theme_options['tips_switch'] == 1)
					{
					?>
					<div class="card mb-4 vector-bg tips">
						<div class="card-body">
						<h4 class="card-title"><?php echo esc_html__('Tips for posting a project','khebrat_theme'); ?></h4>
						  <?php
							$count = 1;
							foreach($khebrat_theme_options['project_slides'] as $single_slide)
							{
						  ?>
					...
					<div class="card mb-4 tips package-info">
						<div class="card-body">
				  <h4 class="card-title"><?php echo esc_html__('Current Plan Detail', 'khebrat_theme' ); ?></h4>
					<p class="view-more-btn"> <a href="<?php echo get_the_permalink(fl_framework_get_options('emp_package_page')); ?>?ext=buy-package" target="_blank"> <?php echo esc_html__(' View Plans ', 'khebrat_theme' ); ?></a></p>
					<?php
						$employer_id = get_user_meta( $current_user_id, 'employer_id' , true );

						$simple_project = get_post_meta( $employer_id, '_simple_projects', true);
						$simple_project_text = isset( $simple_project) && $simple_project == -1 ? esc_html__(' Unlimited ', 'khebrat_theme' ) : $simple_project;
					
						$simple_project_expiry = get_post_meta( $employer_id, '_simple_project_expiry', true);
						$simple_project_expiry_text = isset( $simple_project_expiry) && $simple_project_expiry == -1 ? esc_html__(' Never Expire ', 'khebrat_theme' ) : $simple_project_expiry.esc_html__(' Days ', 'khebrat_theme' );
					
						$featured_projects = get_post_meta( $employer_id, '_featured_projects', true);
						$featured_projects_text = isset( $featured_projects) && $featured_projects == -1 ? esc_html__(' Unlimited ', 'khebrat_theme' ) : $featured_projects;

						$featured_project_expiry = get_post_meta( $employer_id, '_featured_project_expiry', true);
						$featured_project_expiry_text = isset( $featured_project_expiry) && $featured_project_expiry == -1 ? esc_html__(' Never Expire ', 'khebrat_theme' ) : $featured_project_expiry.esc_html__(' Days ', 'khebrat_theme' );

						$employer_package_expiry = get_post_meta( $employer_id, '_employer_package_expiry', true);
					
						$employer_package_expiry_date = get_post_meta( $employer_id, '_employer_package_expiry_date', true);
					
						$package_expiry_text = isset( $employer_package_expiry_date) && $employer_package_expiry_date == -1 ? esc_html__(' Never Expire ', 'khebrat_theme' ) : date_i18n( get_option( 'date_format' ), strtotime($employer_package_expiry_date));
					...
					if(isset($simple_project) && $simple_project != '')
					{
						...
						?>
						<ul>
							<li><img src="<?php echo get_template_directory_uri(); ?>/images/dashboard/success.png" alt="<?php echo esc_attr(get_post_meta($img_id, '_wp_attachment_image_alt', TRUE)); ?>"> <?php echo '<span>'.esc_html__('Project Allowed: ', 'khebrat_theme' ).'</span>'.esc_html($simple_project_text)?> </li>
							<li><img src="<?php echo get_template_directory_uri(); ?>/images/dashboard/success.png" alt="<?php echo esc_attr(get_post_meta($img_id, '_wp_attachment_image_alt', TRUE)); ?>"> <?php echo '<span>'.esc_html__('Project Expiry: ', 'khebrat_theme' ).'</span>'.esc_html($simple_project_expiry_text) ?> </li>
							<li><img src="<?php echo get_template_directory_uri(); ?>/images/dashboard/success.png" alt="<?php echo esc_attr(get_post_meta($img_id, '_wp_attachment_image_alt', TRUE)); ?>"> <?php echo '<span>'.esc_html__('Featured Projects: ', 'khebrat_theme' ).'</span>'.esc_html($featured_projects_text);?> </li>
							<li><img src="<?php echo get_template_directory_uri(); ?>/images/dashboard/success.png" alt="<?php echo esc_attr(get_post_meta($img_id, '_wp_attachment_image_alt', TRUE)); ?>"> <?php echo '<span>'.esc_html__('Featured Projects Expiry: ', 'khebrat_theme' ).'</span>'.esc_html($featured_project_expiry_text); ?> </li>
							<li><img src="<?php echo get_template_directory_uri(); ?>/images/dashboard/success.png" alt="<?php echo esc_attr(get_post_meta($img_id, '_wp_attachment_image_alt', TRUE)); ?>"> <?php echo '<span>'.esc_html__('Featured Profile: ', 'khebrat_theme' ).'</span>'.esc_html($employer_featured_text); ?> </li>
							<li><img src="<?php echo get_template_directory_uri(); ?>/images/dashboard/success.png" alt="<?php echo esc_attr(get_post_meta($img_id, '_wp_attachment_image_alt', TRUE)); ?>"> <?php echo '<span>'.esc_html__('Package Expiry: ', 'khebrat_theme' ).'</span>'.esc_html($package_expiry_text) ?> </li>
						</ul>
						<?php
					}
					else
					{
						echo '<p>'.esc_html__(' No package detail available', 'khebrat_theme' ).'</p>';
					}
					?>
			  </div>
					  </div>
