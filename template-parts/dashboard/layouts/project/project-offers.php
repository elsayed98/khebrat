        ...
        <div class="card-body">
          ...
          <div class="pro-coulmn offer-freelancer">   
                ...
                <?php if($result->offer_Status == "4" || $result->offer_Status == "2" || $result->offer_Status == "3" ){?>
                          <a href="javascript:void(0)" class="btn btn-inverse-danger btn-sm" data-pid="<?php echo esc_attr($result->id ); ?>" data-status="remove" disabled> <i class="far fa-times-circle"></i> <?php echo esc_html__( 'Cancel', 'khebrat_theme' ); ?></a>           
              <?php } 
               else { ?>
                 <a href="javascript:void(0)" class="btn btn-inverse-danger btn-sm" data-pid="<?php echo esc_attr($result->id ); ?>" data-status="remove"> <i class="far fa-times-circle"></i> <?php echo esc_html__( 'Cancel', 'khebrat_theme' ); ?></a> 
