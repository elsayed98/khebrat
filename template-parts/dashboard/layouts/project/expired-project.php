      ...
      <div class="d-flex justify-content-between flex-wrap">
        <div class="d-flex align-items-end flex-wrap">
          <div class="mr-md-3 mr-xl-5">
            <h2><?php echo esc_html__('Expired Projects','khebrat_theme').esc_html(' ('. $total_count.')');?></h2>
							...
							?>
							  <div class="pro-box">
								<div class="pro-coulmn pro-title">
									...
									<span class="pro-btns">
										<a href="javascript:void(0)" class="btn btn-inverse-success text-warning btn-sm reactive_project" data-pid="<?php echo esc_attr($pid); ?>" data-status="active"> <i class="fas fa-sync-alt text-warning"></i> <?php echo esc_html__( 'Active', 'khebrat_theme' ); ?></a>
									</span>
								</div>
