      ...
      <div class="d-flex justify-content-between flex-wrap">
        <div class="d-flex align-items-end flex-wrap">
          <div class="mr-md-3 mr-xl-5">
            <h2><?php echo esc_html__('Active Projects','khebrat_theme').esc_html(' ('. $total_count.')');?></h2>
							...
							?>
							  <div class="pro-box">
								<div class="pro-coulmn pro-title">
									...
									<span class="pro-btns">
										<a href="<?php echo esc_attr(get_permalink($khebrat_theme_options['user_dashboard_page']));?>?ext=create-project&pid=<?php echo esc_html($pid); ?>" class="btn btn-inverse-primary btn-sm"> <i class="far fa-edit"></i> <?php echo esc_html__( 'Edit', 'khebrat_theme' ); ?></a>
                                        ...
                                        <a href="javascript:void(0)" class="btn btn-inverse-danger btn-sm expire_project" data-pid="<?php echo esc_attr($pid); ?>" data-status="expire"> <i class="text-info far fa-trash-alt"></i> <?php echo esc_html__( 'expired', 'khebrat_theme' ); ?></a>

                                        <a href="javascript:void(0)" class="btn btn-inverse-primary btn-sm bump_up_project" data-pid="<?php echo esc_attr($pid); ?>" data-status="bump_up"> <i class="text-info far fa-edit"></i> <?php echo esc_html__( 'Bump up', 'khebrat_theme' ); ?></a>
								...
								<div class="pro-coulmn"><a href="<?php get_template_part( 'project-propsals' );?>?ext=project-propsals&project-id=<?php echo esc_html($pid); ?>" class="btn btn-theme-secondary"> <?php echo esc_html__( 'Proposals ', 'khebrat_theme' ).' ('.$count_bids.')'; ?> </a></div>
							  </div>
