										...
										<div class="fr-project-profile">
										  <div class="fr-project-profile-details">
											...
											<div class="fr-project-user-details"> <a href="<?php echo get_the_permalink($fl_id); ?>">
											  ...
											  <ul>
												<li> <i class="far fa-clock"></i> <span><?php echo esc_html__( 'Assigned on: ', 'khebrat_theme' ).date_i18n( get_option( 'date_format' ), strtotime( $awarded_results->timestamp ) ); ?></span> </li>
								...
								<form id="send_himstory_msg">
									<div class="form-row">
										<div class="form-group col-md-12">
											<textarea name="history_msg_text" id="" class="form-control" required data-smk-msg="<?php echo esc_attr__('Please provide message to send','khebrat_theme'); ?>"></textarea>
										</div>
									</div>
									<div class="form-row">
										<div class="form-group col-md-12">
                    ...
                    <div class="modal-content">
                      ...
                      <div class="modal-body">
                        <form id="rating-form">
							...
							<?php
								if(isset($khebrat_theme_options['allow_project_tip_reward']) && $khebrat_theme_options['allow_project_tip_reward'] != 0)
								{
								?>
									<div class="reward_section">
										<div class="reviews-star-box">
											<ul>
												<li>
													<p> <?php echo esc_html__('Reward or Tip','khebrat_theme'); ?>  </p>
										...
										<div class="form-group reward_box">
											<input type="text" name="reward_tip" class="form-control" placeholder="<?php echo esc_attr__('Amount without currency sign','khebrat_theme'); ?>">
										</div>
									</div>
								<?php
								}
