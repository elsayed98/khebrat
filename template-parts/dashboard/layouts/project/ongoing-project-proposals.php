	...
	if( is_user_logged_in() )
	 {
						  ...
						  <div class="d-flex justify-content-between flex-wrap">
							<div class="d-flex align-items-end flex-wrap">
							  <div class="mr-md-3 mr-xl-5">
								<h2><?php echo esc_html__('Ongoing Project Proposals','khebrat_theme');?></h2>
							...
							?>
								<div class="d-flex justify-content-between align-items-end flex-wrap">
								  <button class="btn btn-theme-secondary mt-2 mt-xl-0" data-toggle="modal" data-target="#milestone"><?php echo esc_html__('Create Milestone', 'khebrat_theme' ); ?></button>
								</div>
							<?php
								}
							}
								...
								<div class="pro-box">
								  ...
								  <div class="pro-coulmn">
									<?php
										...
										{
											?>
											<span class=""> <?php echo esc_html__( 'Total Proposals', 'khebrat_theme' ).' ('.$total_count.')'; ?></span>
											<?php
										}
										else
										{
										...
										<form>                
											<select class="form-control general_select_2 prject_status">
												<option value=""><?php echo esc_html__( 'Project status', 'khebrat_theme' ); ?></option>
												<option value="complete"><?php echo esc_html__( 'Complete', 'khebrat_theme' ); ?></option>
												<option value="cancel"><?php echo esc_html__( 'Cancel', 'khebrat_theme' ); ?></option>
											</select>
											<button type="button" class="btn btn-theme btn-loading" id="project_status" data-pid="<?php echo esc_attr($post->ID); ?>";><?php echo esc_html__( 'Update', 'khebrat_theme' ); ?><div class="bubbles"> <i class="fa fa-circle"></i> <i class="fa fa-circle"></i> <i class="fa fa-circle"></i> </div></button>
										</form>									  		<?php
										}
									?>
								</div>
														...
														if( fl_framework_get_options('whizzchat_project_option') == true)
														{
															...
															?>
																<a href="javascript:void(0)" class="chat_toggler btn btn-theme" data-user_id="<?php echo esc_attr($freelancer_user_id); ?>" data-page_id='<?php echo esc_attr($project_id); ?>'>
																	...
																	<?php echo esc_html__( 'Start Chat', 'khebrat_theme' ); ?>
																</a>
														<?php
															}
														}
														...
														if( fl_framework_get_options('enable_sb_chat_on_project') == true)
      {
          ...
          $classes = 'btn btn-theme'; 
           $button_text  =  __('Start Chat' , 'khebrat_theme');
            ...
            echo do_shortcode('[sb_chat_shortcode_popup class="'.$classes.'"  button_title = "'.$button_text.'" post_author_id="'.$freelancer_user_id.'" ]') ;
														...
														{
															?>
															<a href="<?php get_template_part( 'project-propsals' );?>?ext=ongoing-project-detail&project-id=<?php echo esc_html($project_id); ?>" class="btn btn-theme-secondary"> <?php echo esc_html__( 'View Details', 'khebrat_theme' ); ?></a>
															<?php
														}
													?>
												  <ul>
							  ...
							  <div class="fr-project-bidding proposals-dashboard">
								...
								?>
								<div class="fr-project-box">
								  <h3><?php echo esc_html__( 'Other Proposals', 'khebrat_theme' ); ?></h3>
								</div>
								<div class="project-proposal-box">
								  <?php
									if($results)
									{
												  ...
												  <div class="fr-project-profile-details">
													...
													<div class="fr-project-user-details"> <a href="<?php echo get_the_permalink($result->freelancer_id); ?>">
													  ...
													  <ul>
														...
														<li> <span> <a href="javascript:void(0)" class="cover-letter" data-prpl-id ='<?php echo esc_html($result->id); ?>'> <?php echo esc_html__( 'View Cover Letter', 'khebrat_theme' ); ?> </a></span> </li>
													  </ul>
													</div>
													<div class="fr-project-content-details">
													  <ul>
														<li> <span> <?php echo esc_html(fl_price_separator($result->proposed_cost)); ?> <small>
														  <?php
															...
															{
																echo wp_sprintf(__('Estimated hours %s', 'khebrat_theme'), $result->day_to_complete);
															}
										...
										?>
									  <span class="page-display"><?php echo esc_html__( 'Showing ', 'khebrat_theme' ).esc_html($start_from); ?> - <?php echo esc_html($start_from+$limit).esc_html__( ' out of ', 'khebrat_theme' ).esc_html($total_count); ?> </span>
									  <?php	
									...
									else
									{
										...
										<h3><?php echo esc_html__( 'No proposal found', 'khebrat_theme' ); ?></h3>
										</div>
										<?php
									}
								  ?>
...
//				{
					  ...
					  <div class="modal-dialog" role="document">
						<div class="modal-content">
						  <div class="modal-header">
							<small><?php echo esc_html__('Provide Feedback to ','khebrat_theme'); ?></small>
						  ...
						  <div class="modal-body">
							<form id="rating-form">
								<div class="reviews-star-box">
									<ul>
									  <li>
										<p><?php if(isset($khebrat_theme_options['first_title'])){ echo esc_html($khebrat_theme_options['first_title']); } ?></p>
										<div class="review stars-1"></div>
										<div class="form-group">
										<input type="text" id="stars-1" name="stars_1" value=""  required data-smk-msg="<?php echo esc_attr__('This is required','khebrat_theme'); ?>">
										</div>
									  </li>
									  <li>
										<p><?php if(isset($khebrat_theme_options['second_title'])){ echo esc_html($khebrat_theme_options['second_title']); } ?></p>
										<div class="review stars-2"></div>
										<div class="form-group">
										<input type="text" id="stars-2" name="stars_2"  required data-smk-msg="<?php echo esc_attr__('This is required','khebrat_theme'); ?>">
										</div>
									  </li>
									  <li>
										<p><?php if(isset($khebrat_theme_options['third_title'])){ echo esc_html($khebrat_theme_options['third_title']); } ?></p>
										<div class="review stars-3"></div>
										<div class="form-group">
										<input type="text" id="stars-3" name="stars_3"  required data-smk-msg="<?php echo esc_attr__('This is required','khebrat_theme'); ?>">
										</div>
									  </li>
									</ul>
								</div>
								<div class="form-group">
									<label> <?php echo esc_html__('Feedback ','khebrat_theme'); ?> </label>
									<textarea class="form-control" name="feedback_text" rows="5" cols="10" required data-smk-msg="<?php echo esc_attr__('Please provide feedback','khebrat_theme'); ?>"></textarea>
								</div>
								<div class="form-group"> <button type="button" id="rating-btn" class="btn btn-theme btn-loading" data-pid="<?php echo esc_attr($project_id) ?>" data-status= "complete"><?php echo esc_html__('Complete & Submit','khebrat_theme'); ?> <div class="bubbles"> <i class="fa fa-circle"></i> <i class="fa fa-circle"></i> <i class="fa fa-circle"></i> </div></button> </div>
							</form>
						  </div>
						</div>
					  </div>
					...
					<div class="modal fade review-modal" id="review-modal-cancel" tabindex="-1" role="dialog" aria-labelledby="review-modal-cancel" aria-hidden="true">
					  <div class="modal-dialog" role="document">
						<div class="modal-content">
						  <div class="modal-header">
							<small><?php echo esc_html__('Provide Reason to ','khebrat_theme'); ?></small>
							<h4 class="modal-title" id="review-modal-cancel"><?php echo esc_html__('Cancel Project','khebrat_theme'); ?></h4>
							<button type="button" class="close" data-dismiss="modal" aria-label="Close">
							  <span aria-hidden="true"><i class="fas fa-times"></i></i></span>
							</button>
						  </div>
						  <div class="modal-body">
							<form id="review-modal-cancel">
								<div class="form-group">
									<label> <?php echo esc_html__('Feedback ','khebrat_theme'); ?> </label>
									<textarea class="form-control" name="feedback_text" rows="5" cols="10" required data-smk-msg="<?php echo esc_attr__('Please provide reason','khebrat_theme'); ?>"></textarea>
									<p> <?php echo esc_html__('Provide information on why you are canceling this project.','khebrat_theme'); ?></p>
								</div>
								<div class="form-group"> <button type="button" id="cancel-btn" class="btn btn-theme btn-loading" data-pid="<?php echo esc_attr($project_id) ?>" data-status= "cancel"><?php echo esc_html__('Cancel this project','khebrat_theme'); ?> <div class="bubbles"> <i class="fa fa-circle"></i> <i class="fa fa-circle"></i> <i class="fa fa-circle"></i> </div></button> </div>
							</form>
						  </div>
						</div>
					  </div>
					...
					<div class="modal fade review-modal" id="milestone" tabindex="-1" role="dialog" aria-labelledby="milestone" aria-hidden="true">
					  <div class="modal-dialog" role="document">
						<div class="modal-content">
						  <div class="modal-header">
							<h4 class="modal-title"><?php echo esc_html__('Create Milestones ','khebrat_theme');?></h4>
							<button type="button" class="close" data-dismiss="modal" aria-label="Close">
							  <span aria-hidden="true"><i class="fas fa-times"></i></i></span>
							</button>
						  </div>
						  <div class="modal-body">
							<form id="milestone-form">
								<div class="form-group">
									<label> <?php echo esc_html__('Title ','khebrat_theme'); ?> </label>
									<input type="text" class="form-control" name="milestone_title" required data-smk-msg="<?php echo esc_attr__('Title is required','khebrat_theme'); ?>">
								</div>
								<div class="form-group">
									<label> <?php echo esc_html__('Total Amount','khebrat_theme'); ?> </label>
								...
								<div class="form-group">
									<label> <?php echo esc_html__('Milestone Amount','khebrat_theme'); ?> </label>
									<input type="number" class="form-control" name="current_milestone_amount" required data-smk-msg="<?php echo esc_attr__('Required field with digits only','khebrat_theme'); ?>">
								</div>
								<div class="form-group">
									<label> <?php echo esc_html__('Description ','khebrat_theme'); ?> </label>
									<textarea class="form-control" name="milestone_desc" rows="5" cols="10" required data-smk-msg="<?php echo esc_attr__('This is required','khebrat_theme'); ?>"></textarea>
									<p> <?php echo esc_html__('Write a brief description.','khebrat_theme'); ?></p>
								</div>
								<div class="form-group"> <button type="button" id="create-milestone" class="btn btn-theme btn-loading" data-post-id="<?php echo esc_attr($project_id) ?>"><?php echo esc_html__('Create Milestone','khebrat_theme'); ?> <div class="bubbles"> <i class="fa fa-circle"></i> <i class="fa fa-circle"></i> <i class="fa fa-circle"></i> </div></button> </div>
							</form>
						  </div>
						</div>
					  </div>
