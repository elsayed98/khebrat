                      ...
                      <div class="d-flex justify-content-between flex-wrap">
                        <div class="d-flex align-items-end flex-wrap">
                          <div class="mr-md-3 mr-xl-5">
                            <h2><?php echo esc_html__('Ongoing Service Detail','khebrat_theme');?></h2>
                    ...
                    <div class="col-md-12 grid-margin stretch-card services ongoing-services-details">
                                           ...
                                           // $addons_ids = get_post_meta( $sid, '_services_addon', true );
                                            ...
                                            <div class="pro-box">
                                                <div class="pro-coulmn pro-title">
													...
													{
														?>
                                                        <small class="pro-meta addon-toggle">  <?php echo esc_html__('Addons details','khebrat_theme');?></small>
                                                        <?php
													}
													?>
                           <?php
                      ...
                      ?>
                                                ...
                                                <div class="pro-coulmn buyer-detail">
                                                    ...
                                                    <span class="service_start_date"> <?php echo esc_html__( 'Purchased on ', 'khebrat_theme' ).' '.esc_html(date("F jS, Y", strtotime($result[0]['timestamp']))); ?></span>
                                                </div>
                                                <div class="pro-coulmn">
                                                    <form>                
                                                        <select class="form-control general_select_2 service_status">
                                                            <option value=""><?php echo esc_html__( 'Select status', 'khebrat_theme' ); ?></option>
                                                        ...
                                                        <button type="button" class="btn btn-theme btn-loading" id="service_status"><?php echo esc_html__( 'Update', 'khebrat_theme' ); ?><div class="bubbles"> <i class="fa fa-circle"></i> <i class="fa fa-circle"></i> <i class="fa fa-circle"></i> </div></button>
                                                    </form>
                                                </div>
                                              </div>
                                            <?php
                                ...
                                <form id="send_service_msg">
                                    <div class="form-row">
                                        <div class="form-group col-md-12">
                                            <textarea name="history_msg_text" id="" class="form-control" required data-smk-msg="<?php echo esc_attr__('Please provide message to send','khebrat_theme'); ?>" placeholder="<?php echo esc_attr__('Type your message here.....','khebrat_theme'); ?>"></textarea>
                                        </div>
                                    </div>
                                    <div class="form-row">
                                        <div class="form-group col-md-12">
                      ...
                      <div class="modal-body">
                        <form id="service_rating_form">
                            <div class="reviews-star-box">
                                <ul>
                                  <li>
                                    <p><?php if(isset($khebrat_theme_options['service_first_title'])){ echo esc_html($khebrat_theme_options['service_first_title']); } ?></p>
                                  ...
                                  <li>
                                    <p><?php if(isset($khebrat_theme_options['service_second_title'])){ echo esc_html($khebrat_theme_options['service_second_title']); } ?></p>
                                  ...
                                  <li>
                                    <p><?php if(isset($khebrat_theme_options['service_third_title'])){ echo esc_html($khebrat_theme_options['service_third_title']); } ?></p>
                            ...
                            <div class="form-group"> <button type="button" id="service_rating_btn" class="btn btn-theme btn-loading" data-ongoing-sid="<?php echo esc_attr($ongoing_sid) ?>" data-service-sid="<?php echo esc_attr($post_service_id) ?>" data-status= "complete"><?php echo esc_html__('Complete & Submit','khebrat_theme'); ?> <div class="bubbles"> <i class="fa fa-circle"></i> <i class="fa fa-circle"></i> <i class="fa fa-circle"></i> </div></button> </div>
                        </form>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="modal-dialog" role="document">
                    <div class="modal-content">
                      <div class="modal-header">
                        ...
                        <h4 class="modal-title" id="review-modal-cancel"><?php echo esc_html__('Cancel Service','khebrat_theme'); ?></h4>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                          <span aria-hidden="true"><i class="fas fa-times"></i></i></span>
                        </button>
                      </div>
                      <div class="modal-body">
                        <form id="cancel-service-from">
                            <div class="form-group">
                                ...
                                <p> <?php echo esc_html__('Provide information on why you are canceling this service.','khebrat_theme'); ?></p>
                            </div>
                            <div class="form-group"> <button type="button" id="cancel-service-btn" class="btn btn-theme btn-loading" data-ongoing-sid="<?php echo esc_attr($ongoing_sid) ?>" data-service-sid="<?php echo esc_attr($post_service_id) ?>" data-status= "cancel"><?php echo esc_html__('Cancel this service','khebrat_theme'); ?> <div class="bubbles"> <i class="fa fa-circle"></i> <i class="fa fa-circle"></i> <i class="fa fa-circle"></i> </div></button> </div>
                        </form>
                      </div>
                    </div>
                  </div>
