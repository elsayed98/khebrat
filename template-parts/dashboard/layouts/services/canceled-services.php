              ...
              <div class="d-flex justify-content-between flex-wrap">
                <div class="d-flex align-items-end flex-wrap">
                  <div class="mr-md-3 mr-xl-5">
                    <h2><?php echo esc_html__('Canceled Services','khebrat_theme'); ?></h2>
                ...
                <div class="card-body">
                  <div class="pro-section">
                      <div class="pro-box heading-row">
                        ...
                        <div class="pro-coulmn"><?php echo esc_html__( 'Offered by', 'khebrat_theme' ) ?> </div>
                                ...
                                foreach( $result as $results ) 
                                {
                                    ...
                                    <div class="pro-box">
                                        ...
                                        <div class="pro-coulmn buyer-detail">
                                            ...
                                            <span class="service_start_date"> <?php echo esc_html__( 'Ordered on ', 'khebrat_theme' ).' '.esc_html(date("F jS, Y", strtotime($results->timestamp))); ?></span>
                                        </div>
                                        <div class="pro-coulmn">
                                        	<a href="?ext=canceled-service-detail&sid=<?php echo esc_html($ongoing_sid); ?>" class="btn btn-theme-secondary"><?php echo esc_html__( 'View Detail', 'khebrat_theme' ); ?></a>
                                        </div>
                                      </div>
                                    <?php
                                }
