              ...
              <div class="d-flex justify-content-between flex-wrap">
                <div class="d-flex align-items-end flex-wrap">
                  <div class="mr-md-3 mr-xl-5">
                    <h2><?php echo esc_html__('Ongoing Services','khebrat_theme'); ?></h2>
                                ...
                                foreach( $result as $results ) 
                                {
                                    ...
                                    <div class="pro-box">
                                        ...
                                        <div class="pro-coulmn">
                                        	<a href="?ext=ongoing-service-detail&sid=<?php echo esc_html($ongoing_sid); ?>" class="btn btn-theme-secondary"><?php echo esc_html__( 'View Detail', 'khebrat_theme' ); ?></a>
                                        </div>
                                      </div>
                                    <?php
									}
