                      ...
                      <div class="d-flex justify-content-between flex-wrap">
                        <div class="d-flex align-items-end flex-wrap">
                          <div class="mr-md-3 mr-xl-5">
                            <h2><?php echo esc_html__('Canceled Service Detail','khebrat_theme');?></h2>
                                    ...
                                    if ( $result )
                                    {
                                            ...
                                            <div class="pro-box">
                                                    ...
                                                    <span class="pro-meta-box">
                                                        ...
                                                        <span>
                                                        	<a href="javascript:void(0)" data-toggle="modal" data-target="#view-remarks">
																<?php echo esc_html__( 'View Remarks ', 'khebrat_theme' ); ?>
                                                            </a>
                                                        </span>
                                                    </span>
                                                </div>
                                                <div class="pro-coulmn buyer-detail">
                                                    ...
                                                    <span class="service_start_date"> <?php echo esc_html__( 'Started on ', 'khebrat_theme' ).' '.esc_html(date("F jS, Y", strtotime($result[0]['timestamp']))); ?></span>
                                                </div>
                                                <div class="pro-coulmn completed-status canceled">
                                                    <i class="fas fa-times-circle"></i>
                                                    <div>
                                                    	<span class=""> <?php echo esc_html__( 'Canceled ', 'khebrat_theme' ); ?> </span>
                                                        <small> <?php echo esc_html__( 'on ', 'khebrat_theme' ).date_i18n( get_option( 'date_format' ), strtotime( $result[0]['status_date'] ) ); ?> </small> </div>
                                                </div>
                                              </div>
                                            <?php
                                    }
                  ...
                  <div class="modal-dialog" role="document">
                    <div class="modal-content">
                      <div class="modal-header">
                      	<small><?php echo esc_html__('Remarks on','khebrat_theme'); ?></small>
                        <h4 class="modal-title" id="review-modal-cancel"><?php echo esc_html__('Service Cancellation','khebrat_theme'); ?></h4>
