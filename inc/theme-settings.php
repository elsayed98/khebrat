...
register_nav_menus( array(
	'main_theme_menu'    => esc_html__( 'Exertio Menu', 'khebrat_theme' ),
) );
register_nav_menus( array(
    'footer_menu'    => esc_html__( 'Exertio Footer Menu', 'khebrat_theme' ),
) );
// Register SIDEBARS
...
'name' => __( 'Exertio Blog Widget', 'khebrat_theme' ),
'description' => __( 'All the blog page widgets will be placed here.', 'khebrat_theme' ),
...
function exertio_services_sidebar()
{
	...
	'name' => __( 'Exertio Services Sidebar Widget', 'khebrat_theme' ),
	'description' => __( 'All the services page sidebar widgets will be placed here.', 'khebrat_theme' ),
	'before_title' => '',
	'after_title' => '<',
	'before_widget' => '',
	'after_widget' => '',
...
$form = '<form role="search" method="get" class="search-form" action="' . home_url( '/' ) . '">
				<div class="fl-search-blog"><div class="input-group stylish-input-group">
					...
					<input type="search" class="form-control" placeholder="' .esc_attr__( 'Search for:', 'khebrat_theme' ). '" value="'.get_search_query().'" name="s" id="s"/>
...
function exertio_project_sidebar()
{
	...
	'name' => __( 'Exertio Project Sidebar Widgets', 'khebrat_theme' ),
	'description' => __( 'All the project page sidebar widgets will be placed here.', 'khebrat_theme' ),
	'before_title' => '',
	'after_title' => '<',
	'before_widget' => '',
	'after_widget' => '',
...
function exertio_employer_sidebar()
{
	...
	'name' => __( 'Exertio Employer Sidebar Widgets', 'khebrat_theme' ),
	'description' => __( 'All the employer page sidebar widgets will be placed here.', 'khebrat_theme' ),
	'before_title' => '',
	'after_title' => '<',
	'before_widget' => '',
	'after_widget' => '',
...
function exertio_freelancer_sidebar()
{
	...
	'name' => __( 'Exertio Freelancer Sidebar Widgets', 'khebrat_theme' ),
	'description' => __( 'All the freelancer page sidebar widgets will be placed here.', 'khebrat_theme' ),
	'before_title' => '',
	'after_title' => '<',
	'before_widget' => '',
	'after_widget' => '',
...
function exertio_woo_commerce_sidebar()
{
    $args = array(
        ...
        'name' => __( 'Exertio Woo-commerce Sidebar Widgets', 'khebrat_theme' ),
        'description' => __( 'All the Product page sidebar widgets will be placed here.', 'khebrat_theme' ),
