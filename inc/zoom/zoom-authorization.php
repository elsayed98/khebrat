...
//          exit;
            if (isset($result_token['access_token']) && $result_token['access_token'] != "") {
                ...
                $message = __("Token Generated Successfully now you can use Zoom Meeting services", "khebrat_theme");
                            ...
                            <div class="deposit-box card">
                                <div class="depoist-header">
                                    ...
                                    <div class="deposit-header-text">
                                        ...
                                        <p><?php echo esc_html__('Please fill the form for Meetings', 'khebrat_theme'); ?></p>
                                    </div>
                                </div>
                                    ...
                                    <form class="zoom-metting-form" id="edit_meeteing_modal" enctype="multipart/form-data">
                                        <div class="form-row">
                                            <div class="form-group col-lg-12 col-md-3 col-xs-12 col-sm-3">                                    
                                                <label><?php echo esc_html__('Meeting Title:', 'khebrat_theme'); ?></label>
                                                <input class="form-control" type="text" name="meeting_title" id ="meeting_title" required="" value="<?php echo esc_html($meeting_topic); ?>" required data-smk-msg="<?php echo esc_attr__('This field is required', 'khebrat_theme'); ?>">      
                                            </div>
                                            <div class=" form-group col-lg-6 col-md-3 col-xs-12 col-sm-3"> 
                                                <label><?php echo esc_html__('Meeting Date:', 'khebrat_theme'); ?></label> 
                                                <input class="form-control" type="date"  name="meeting_date" id ="meeting_date" required="" value="<?php echo esc_html($meeting_date); ?>" required data-smk-msg="<?php echo esc_attr__('This field is required', 'khebrat_theme'); ?>">
                                            </div>
                                            <div class="col-lg-6 col-md-3 col-xs-12 col-sm-3"> 
                                                <label><?php echo esc_html__('Meeting Time:', 'khebrat_theme'); ?></label> 
                                                <input class="form-control" type="time" name="meeting_time" id ="meeting_time" required="" value="<?php echo esc_html($meeting_time); ?>" required data-smk-msg="<?php echo esc_attr__('This field is required', 'khebrat_theme'); ?>">
                                            </div>
                                            <div class="col-lg-12 col-md-3 col-xs-12 col-sm-3"><label><?php echo esc_html__('Meeting Duration (Minutes)', 'khebrat_theme'); ?></label> 
                                                <input  value="<?php echo esc_html($meeting_duration); ?>" class="form-control account-members" required="" type="text" name="meeting_duration" id"meeting_duration" required data-smk-msg="<?php echo esc_attr__('This field is required', 'khebrat_theme'); ?>"></div>        

                                            <div class="col-lg-12 col-md-3 col-xs-12 col-sm-3"> <label><?php echo esc_html__('Meeting Password', 'khebrat_theme'); ?></label> 
                                                <input class="form-control" value="<?php echo esc_html($meeting_password); ?>" required="" type="text" name="meeting_password"  required data-smk-msg="<?php echo esc_attr__('This field is required', 'khebrat_theme'); ?>"></div>    

                                            <div class="col-lg-12 col-md-3 col-xs-12 col-sm-3"> <label><?php echo esc_html__('Special Note', 'khebrat_theme'); ?></label> 
                                                <input class="form-control" value="<?php echo esc_html($meeting_note); ?>" required="" type="textarea" rows="4" cols="50" name="meeting_note"  required data-smk-msg="<?php echo esc_attr__('This field is required', 'khebrat_theme'); ?>"></div>    
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <button type="button" id ="custom_close" class="btn-black" data-dismiss="modal"><?php echo esc_html__('Close', 'khebrat_theme'); ?></button>
...
if (!function_exists('exertio_setup_zoom_meeting')) {
    ...
    function exertio_setup_zoom_meeting() {
        ...
        if ($user_id->ID != is_author()) {
            ...
            echo esc_html__('Something went wrong', 'khebrat_theme');
            exit;
        } else {
            ...
            if (isset($result['id']) && $result['id'] != "") {
                ...
                $json_data = array('error' => '0', 'msg' => esc_html__('Meeting Created Succesfully', 'khebrat_theme'));
            ...
            else if (!isset($result['id']) && $meeting_id != "")
            {
                ...
                $json_data = array('error' => '0', 'msg' => esc_html__('Meeting Updated Succesfully', 'khebrat_theme'));
                wp_send_json_success($json_data);
            }
            else
            {
                $json_data = array('error' => '0', 'msg' => esc_html__('Get Authorized before creating/updating new Meeting1', 'khebrat_theme'));
...
if (!function_exists('exertio__zoom_delete_meet')) {
    ...
    function exertio__zoom_delete_meet() {
        ...
        if (isset($meeting_id) && $meeting_id != "" && $access_token != '') {
            ...
            $json_data = array('error' => '0', 'msg' => esc_html__('Meeting Deleted Succesfully', 'khebrat_theme'));
            wp_send_json_success($json_data);
        } else {
            $json_data = array('error' => '0', 'msg' => esc_html__('Refresh token please before Creating/Updating new meeting', 'khebrat_theme'));
            wp_send_json_error($json_data);
        }
