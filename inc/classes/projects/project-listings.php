            	...
            	<div class="fr-right-detail-box <?php echo esc_attr( $ext_title_class); ?>" data-post-id = "<?php echo $project_id; ?>">
                        	...
                        	<?php
								...
								else if($type == 'hourly' || $type == 2)
								{
									...
									if(isset($hourly_price) && $hourly_price != '' && isset($estimated_hours) && $estimated_hours != '')
									{
										...
										$save_text = esc_html__( 'Estimated Hours ', 'khebrat_theme' ).$estimated_hours."<br><br>".esc_html__( 'Total: ', 'khebrat_theme' ).get_post_meta($project_id, '_project_cost', true)."*".$estimated_hours."= ".fl_price_separator($total_hourly_price);
                  ...
                  <div class="fr-right-information">
                    <div class="fr-right-list">
                      <ul>
                        <li>
                          <p class="heading"> <?php echo esc_html__( 'Expiry: ', 'khebrat_theme' ); ?></p>
                          <div><?php echo project_expiry_calculation($project_id); ?></div>
                        </li>
                        <li>
                          <p class="heading"><?php echo esc_html__( 'Proposals', 'khebrat_theme' ); ?></p>
                          <?php
						  ...
						  ?>
                          <span><?php echo esc_html($results).esc_html__( ' Received ', 'khebrat_theme' ); ?></span>
                        </li>
                        <?php
                    ...
                    <div class="fr-right-bid">
                      <ul>
                      	<?php
							$saved_project = '';
							$save_text = esc_html__( 'Save project', 'khebrat_theme' );
                        ...
                        <li><a href="<?php echo esc_url(get_the_permalink()); ?>" class="btn btn-theme"><?php echo esc_html__( ' Send Proposal ', 'khebrat_theme' ); ?></a></li>
                      </ul>
                    </div>
                  </div>
                </div>
                ...
                <div class="res-us-details">
                    ...
                    <div class="res-us-inline">
                      <ul>
						...
						?>
                        <li><span><i class="fas fa-gavel"></i>  <?php echo esc_html($bid_results).esc_html__( ' Proposals', 'khebrat_theme' ); ?></span></li>
                        ...
                        <li class="fr1-top-content">
                            ...
                            <p><a href="<?php echo esc_url(get_the_permalink()); ?>" class="btn btn-theme"><?php echo esc_html__( 'View Job', 'khebrat_theme' ); ?></a></p>
                        </li>
                      </ul>
                    </div>
                    <?php
            ...
            <div class="<?php echo esc_attr($col_size); ?>">
                <div class="fr-latest2-content-box">
				  ...
				  <div class="fr-latest2-price">
					<ul>
					  <li> <span> <?php echo esc_html__( 'Price ', 'khebrat_theme' ); ?></span>
						<p class="info-in">
							<?php
								$project_type_text =  '';
								$type = get_post_meta($project_id, '_project_type', true);
					  ...
					  <li> <span class="info-col"><?php echo esc_html__( 'Expiry', 'khebrat_theme' ); ?></span>
						<?php echo project_expiry_calculation($project_id); ?>
					  </li>
					  <li> <span class="info-col"> <?php echo esc_html__( 'Proposals', 'khebrat_theme' ); ?></span>
						<p> <?php echo esc_html($bid_results).esc_html__( ' Received', 'khebrat_theme' ); ?></p>
					  </li>
					</ul>
				  </div>
