...
if (!class_exists('exertio_get_freelancers_class'))
{
	class exertio_get_freelancers_class 
	{
               ...
               <div class="<?php echo esc_attr($col_html); ?> grid-item">
				  <div class="fr3-product-detail-box">
								...
								else
								{
									...
									if($hourly_rate != '')
									{
									  ...
									  <li>
										  ...
										  <span class="bottom-text"><?php echo esc_html__(' hourly','khebrat_theme'); ?></span>
									  </li>
									  <?php
									}
								}
					  ...
					  <p>
						  ...
						  <?php echo esc_html__('Member since ','khebrat_theme').get_the_date(); ?></p>
					  </div>
					  
					  <div class="fr3-product-btn">
						  <a href="<?php echo get_the_permalink($freelancer_id); ?>" class="btn btn-theme"><?php echo esc_html__('View Profile','khebrat_theme'); ?></a>
					  </div>
		...
		function exertio_freelancer_grid_2($freelancer_id, $cols = '') 
		{
			...
			if(isset($featured_freelancer) && $featured_freelancer == 1)
			{
				$featured_badge = '<div class="d-flex flex-row agent-type"><span class="badge badge-agent-type">'.esc_html__( 'Featured', 'khebrat_theme' ).'</span></div>';
			}
			if($cols == '')
			{
                          ...
                          <div class="fr3-job-text">
                              ...
                              <?php
								...
								else
								{
									...
									{
									  ?>
										  <p class="price-tag"><?php echo fl_price_separator($hourly_rate, 'html'); ?><span class="bottom-text"><?php echo esc_html__(' / hr','khebrat_theme'); ?></span></p>
									  <?php
									}
								}
								?>
                                <ul class="lists">
                                    <li> <?php echo esc_html__('Member since ','khebrat_theme').get_the_date(); ?></li>
                                  </ul>
                                <?php
									$current_user_id = get_current_user_id();
									$saved_freelancer = get_user_meta($current_user_id, '_fl_follow_id_'.$freelancer_id, true);
									$active_saved ='';
									$save_text = esc_html__('Follow','khebrat_theme');
									if(isset($saved_freelancer) && $saved_freelancer != '')
									{
										$active_saved = 'active';
										$save_text = esc_html__('Following','khebrat_theme');	
									}
								?>
                    ...
                    <div class="fr-lance-content3">
                      ...
                      <div class="fr-lance-more-details">
                          	...
                          	<?php
								...
								else
								{
									...
									if($hourly_rate != '')
									{
									  ?>
										  <p><?php echo fl_price_separator($hourly_rate, 'html'); ?></p>
										  <span class="bottom-text"><?php echo esc_html__('/ hr','khebrat_theme'); ?></span>
									  <?php
									}
								}
							?>
                        ...
                        <div class="fr-lance-products2">
                          ...
                          <p><i class="far fa-calendar-alt"></i><?php echo esc_html__('Member since ','khebrat_theme').get_the_date(); ?></p>
                        </div>
                        <?php
					  $saved_skills =  json_decode(stripslashes(get_post_meta($freelancer_id, '_freelancer_skills', true)), true);
					  if($saved_skills != '')
