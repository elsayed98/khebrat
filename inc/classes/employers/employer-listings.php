...
if (!class_exists('exertio_get_employers_class'))
{
	class exertio_get_employers_class 
	{
		...
		function exertio_employers_grid_1($employer_id) 
		{
			...
			if(empty($banner_img ))
			{
				$cover_img = "style='background-image:url(".$khebrat_theme_options['employer_df_cover']['url']."); background-size: cover; background-repeat: no-repeat;'";
			}
			else
			{
                    ...
                    <div class="fr-employ-content">
                      ...
                      <div class="fr-employ-container"> 
                        ...
                        <div class="fr-employer-assets">
                            ...
                            {
                                ?>
                                <a href="javascript:void(0)" class="following protip" data-pt-position="top" data-pt-scheme="black" data-pt-title="<?php echo esc_attr__('Already Following','khebrat_theme'); ?>"><i class="far fa-heart"></i></a>
                                <?php
                            }
                            else
                            {
							?>
                            <a href="javascript:void(0)" class="follow-employer protip" data-pt-position="top" data-pt-scheme="black" data-pt-title="<?php echo esc_attr__('Click to Follow','khebrat_theme'); ?>" data-emp-id="<?php echo esc_attr($employer_id); ?>"><i class="far fa-heart"></i></a>
                            
                            <?php
							}
							?>
                            <a href="<?php echo get_the_permalink($employer_id); ?>" class="btn btn-theme"> <?php echo esc_html__('View Profile','khebrat_theme'); ?></a>
                        </div>
                      </div>
                    </div>
                </div>
                    ...
                    ?>
					  <div class="fr3-box-img" <?php echo wp_return_echo($cover_img); ?>>
						  ...
						  <div class="fr3-box-icons">
                            ...
                            {
                                ?>
                                <a href="javascript:void(0)" class="following protip" data-pt-position="top" data-pt-scheme="black" data-pt-title="<?php echo esc_attr__('Already Following','khebrat_theme'); ?>"><i class="fa fa-heart"></i></a>
                                <?php
                            }
                            else
                            {
                                ?>
                                <a href="javascript:void(0)" class="follow-employer protip" data-pt-position="top" data-pt-scheme="black" data-pt-title="<?php echo esc_attr__('Click to Follow','khebrat_theme'); ?>" data-emp-id="<?php echo esc_attr($employer_id); ?>"><i class="fa fa-heart"></i></a>
					  ...
					  <div class="fr-btn-grid">
					  	 <a href="<?php echo get_the_permalink($employer_id); ?>" class=""> <?php echo esc_html__('View Profile','khebrat_theme'); ?></a>
					  </div>
				  </div>
			  </div>
              <?php
