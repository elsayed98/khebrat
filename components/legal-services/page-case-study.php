                         ...
                         <div class="card-body p-4">
                             <div class="row g-md-4">
                                 ...
                                 <div class="col-md-9">
                                     ...
                                     <div class="">
                                         ...
                                         <div class="col-md-12 mt-2">
                                             <small><?php echo esc_html__('اختيار اذا كانت الدراسة تتعلق بقضية قائمة حاليا او لا :', 'khebrat_theme'); ?></small>

                                             <span class="h6 mb-0 fw-normal ms-1"><?php echo (get_post_meta($lsid, '_study_related', true) == '1') ? 'نعم' : 'لا'; ?></span>
                                         </div>
                                     </div>
                                 </div>
                                 ...
                                 <div class="col-md-6">
                                     <ul class="list-group list-group-borderless">
                                         <li class="list-group-item"><?php echo esc_html__('مدعي أم مدعى عليه : ', 'khebrat_theme'); ?><span class="h6 fw-normal mb-0 ms-1"><?php echo $case_role ?></span></li>
                                         <?php
                                            if ($case_role == 'مدعي') {
                             ...
                             <div class="row">
                                 ...
                                 <div class="col-sm-8">
                                     ...
                                     <div class="mb-2">
                                         <small><?php echo esc_html__('الأسئلة المطلوب الإجابة عليها', 'khebrat_theme'); ?></small>
                                         <p class="h6 fw-light mb-md-0"><?php echo get_field_meta($lsid, '_case_questions', 'لا يوجد') ?></p>
                                     </div>
                                 </div>
                             ...
                             <?php
                                ...
                                ?>
                                <a class="btn btn-primary w-100" href="<?php echo esc_attr(get_permalink($khebrat_theme_options['user_dashboard_page'])); ?>?ext=service-offers&sfid=<?php echo esc_html($lsid); ?>"> <?php echo esc_html__('مشاهدة العروض', 'khebrat_theme'); ?></a>
