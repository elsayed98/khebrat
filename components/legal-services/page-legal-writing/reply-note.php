                ...
                <div class="vstack gap-4">
                    ...
                    <div class="card shadow">
                        ...
                        <div class="card-header border-bottom p-4">
                            <h1 class="mb-0 fs-3"><?php echo $service_type . ' - مذكرة رد على الدعوى' ?></h1>
                        </div>
                                    ...
                                    <div class="card shadow-sm border-0 mb-4">
                                        <div class="card-body">
                                            ...
                                            <div class="mb-3 border-bottom pb-3">
                                                <small class="fs-6 d-block mb-1"><i class="bi bi-chat-left-text me-1"></i>موضوع الطلب</small>
                                            ...
                                            <div class="mb-3 border-bottom pb-3">
                                                <small class="fs-6 d-block mb-1"><i class="bi bi-journal-text me-1"></i>الرد على الدعوى</small>
                                                <div class="post-desc h6 fw-light"><?php echo esc_html(get_field_meta($lsid, '_reply_to_claim', 'لا يوجد')); ?></div>
                                            </div>
                                            <div class="mb-3 border-bottom pb-3">
