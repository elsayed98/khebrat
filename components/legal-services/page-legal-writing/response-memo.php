                ...
                <div class="vstack gap-4">
                    ...
                    <div class="card shadow">
                        ...
                        <div class="card-header border-bottom p-4">
                            <h1 class="mb-0 fs-3"><?php echo $service_type . ' - مذكرة رد جوابية' ?></h1>
                        </div>
                                        ...
                                        <div class="card-body p-3">
                                            ...
                                            <ul class="list-group list-group-flush">
                                                ...
                                                <li class="list-group-item d-flex justify-content-between">
                                                    <span><i class="bi bi-card-heading me-2"></i>عدد الجلسات</span>
                                                    <span class="fw-bold"><?php echo esc_html(get_post_meta($lsid, '_previous_sessions_count', true) ?: 'غير محدد'); ?></span>
                                                </li>
                                                <!-- التاريخ -->
                                                <li class="list-group-item d-flex justify-content-between">
                                    ...
                                    <div class="card shadow-sm border-0 mb-4">
                                        <div class="card-body">
                                            ...
                                            <div class="mb-3 border-bottom pb-3">
                                                ...
                                                <div class="post-desc h6 fw-light"><?php echo esc_html(get_field_meta($lsid, '_legal_answer', 'لا يوجد')); ?></div>
                                            </div>
                                            <div class="mb-3 border-bottom pb-3">
