<?php
//صفحة - كتابات قانونية  - لائحة التماس
                ...
                <div class="vstack gap-4">
                    ...
                    <div class="card shadow">
                        ...
                        <div class="card-header border-bottom p-4">
                            <h1 class="mb-0 fs-3"><?php echo $service_type . '  - لائحة التماس' ?></h1>
                        </div>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="card border rounded-3 mb-2">
                                        <div class="card-body p-3">
                                            <h5 class="card-title mb-3"><i class="bi bi-calendar-check me-2"></i>معلومات الخطاب</h5>
                                            <ul class="list-group list-group-flush">
                                                <!-- تاريخ تقديم الخطاب-->
                                                <?php if (!empty($sender_type)): ?>
                                                    <li class="list-group-item d-flex justify-content-between">
                                                        <span><i class="bi bi-person me-2"></i>صفة مقدم الخطاب</span>
                                                        <span class="fw-bold"><?php echo esc_html($types[$sender_type] ?? $sender_type); ?></span>
                                                    </li>
                                                <?php endif; ?>

                                                <?php if (!empty($recipient_type)): ?>
                                                    <li class="list-group-item d-flex justify-content-between">
                                                        <span><i class="bi bi-building me-2"></i>الجهة المقدّم لها</span>
                                                        <span class="fw-bold"><?php echo esc_html($types[$recipient_type] ?? $recipient_type); ?></span>
                                                    </li>
                                                <?php endif; ?>

                                                <li class="list-group-item d-flex justify-content-between">
                                                    <span><i class="bi bi-card-heading me-2"></i>تاريخ تقديم الخطاب</span>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-12">
                                    <div class="card shadow-sm border-0 mb-4">
                                        <div class="card-body">
                                            <h5 class="card-title mb-4 text-primary"><i class="bi bi-file-earmark-text-fill me-2"></i>تفاصيل القضية</h5>
                                            ...
                                            <div class="mb-3 border-bottom pb-3">
                                                <small class="fs-6 d-block mb-1"><i class="bi bi-journal-text me-1"></i> اسم الجهة </small>
                                                <div class="post-desc h6 fw-light"><?php echo esc_html(get_field_meta($lsid, '_organization_name', 'لا يوجد')); ?></div>
                                            </div>
                                            <div class="mb-3 border-bottom pb-3">
                                                <small class="fs-6 d-block mb-1"><i class="bi bi-journal-text me-1"></i>موضوع القضية </small>
